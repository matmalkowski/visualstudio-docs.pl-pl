---
title: Tworzenie środowiska programowania .NET Core z kontenerami przy użyciu Kubernetes w chmurze za pomocą programu Visual Studio — krok 7 — podsumowanie | Dokumentacja firmy Microsoft
author: ghogen
ms.author: ghogen
ms.date: 04/05/2018
ms.topic: tutorial
...
Poprzedni krok: [Dowiedz się więcej na temat tworzenia zespołu](get-started-netcore-visualstudio-06.md)
