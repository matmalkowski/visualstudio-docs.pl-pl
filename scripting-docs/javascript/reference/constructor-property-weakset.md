---
title: constructor — właściwość (WeakSet) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790348"
---
# <a name="constructor-property-weakset"></a>constructor (WeakSet) — właściwość
Określa funkcję, która tworzy `WeakSet`.  
...
## <a name="remarks"></a>Uwagi  
 Wymagane `weakset` jest nazwą zestawu.  
