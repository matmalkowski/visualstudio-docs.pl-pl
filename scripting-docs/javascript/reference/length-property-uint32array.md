---
title: Właściwość length (Uint32Array) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791023"
---
# <a name="length-property-uint32array"></a>Właściwość length (Uint32Array)
Długość tablicy.  
