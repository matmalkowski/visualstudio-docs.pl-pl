---
title: lastMatch właściwość ($&amp;) (RegExp) (JavaScript) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790861"
---
# <a name="lastmatch-property-amp-regexp-javascript"></a>lastMatch właściwość ($&amp;) (RegExp) (JavaScript)
Zwraca ostatnie znaki dopasowane z wyszukiwania wyrażenia regularnego. Tylko do odczytu.  
...
## <a name="remarks"></a>Uwagi  
 ...
 Początkowa wartość `lastMatch` właściwość jest ciągiem pustym. Wartość `lastMatch` zmiany właściwości po każdej pomyślnego dopasowania.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład przedstawia użycie `lastMatch` właściwości:  
