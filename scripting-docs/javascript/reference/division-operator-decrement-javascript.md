---
title: Operator dzielenia (-) (JavaScript) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790402"
---
# <a name="division-operator---javascript"></a>Operator dzielenia (-) (JavaScript)
Dzieli wartości dwóch wyrażeń.  
...
## <a name="see-also"></a>Zobacz też  
 [Operator przypisania dzielenia (/ =)](../../javascript/reference/division-assignment-operator-decrement-equal-javascript.md)   
