---
title: constructor — właściwość (Map) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790318"
---
# <a name="constructor-property-map"></a>constructor — Właściwość (Map)
Określa funkcję, która tworzy mapę.  
