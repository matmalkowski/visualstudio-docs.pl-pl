---
title: getDate — metoda (Data) (JavaScript) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790546"
---
# <a name="getdate-method-date-javascript"></a>getDate — Metoda (Data) (JavaScript)
Pobiera dzień miesiąca, przy użyciu czasu lokalnego.  
...
## <a name="remarks"></a>Uwagi  
 Aby uzyskać dzień miesiąca przy użyciu uniwersalnego czasu koordynowanego (UTC), należy użyć `getUTCDate` metody.  
  
## <a name="example"></a>Przykład  
 Poniższy przykład przedstawia użycie `getDate` metody.  
