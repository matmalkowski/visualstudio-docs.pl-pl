---
title: byteLength właściwość (UInt32Array) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24788893"
---
# <a name="bytelength-property-uint32array"></a>byteLength Właściwość (UInt32Array)
