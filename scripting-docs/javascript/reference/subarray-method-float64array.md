---
title: Metoda subarray (Float64Array) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791455"
---
# <a name="subarray-method-float64array"></a>Metoda subarray (Float64Array)
Pobiera nowy widok Float64Array [arraybuffer — obiekt](../../javascript/reference/arraybuffer-object.md) magazynu dla tej tablicy, określając imię i nazwisko członkami subarray.  
