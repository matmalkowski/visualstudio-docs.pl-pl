---
title: Właściwość length (Float32Array) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790810"
---
# <a name="length-property-float32array"></a>Właściwość length (Float32Array)
Długość tablicy.  
