---
title: Jsbooltoboolean — funkcja | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24788209"
---
# <a name="jsbooltoboolean-function"></a>JsBoolToBoolean — Funkcja
Tworzy wartość logiczną z `bool` wartości.  
