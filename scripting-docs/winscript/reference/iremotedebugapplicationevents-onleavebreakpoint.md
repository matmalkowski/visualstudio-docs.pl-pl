...
#### <a name="parameters"></a>Parametry  
 `prdat`  
 [in] Wątek aplikacji, który punkt przerwania w lewo.  
...
## <a name="remarks"></a>Uwagi  
 Ta metoda obsługuje zdarzenie opuszczenia punktu przerwania.  
