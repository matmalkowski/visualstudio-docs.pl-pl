---
title: Interfejs IEnumDebugStackFrames | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 01/18/2017
...
Wylicza ramek stosu odpowiadający wątku.  
  
## <a name="methods"></a>Metody  
 Oprócz dziedziczone z metody `IUnknown`, `IEnumDebugStackFrames` interfejsu udostępnia następujące metody.  
...
|[IEnumDebugStackFrames::Reset](../../winscript/reference/ienumdebugstackframes-reset.md)|Resetuje sekwencję wyliczenia na początku.|  
|[IEnumDebugStackFrames::Clone](../../winscript/reference/ienumdebugstackframes-clone.md)|Tworzy moduł wyliczający, który zawiera stan tego samego jako bieżący modułu wyliczającego.|