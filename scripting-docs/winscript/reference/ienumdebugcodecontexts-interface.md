...
Wylicza kontekstach kodu, które odpowiadają kontekstu dokumentu.  
 ...
 Oprócz dziedziczone z metody `IUnknown`, `IEnumDebugCodeContexts` interfejsu udostępnia następujące metody.  
...
|[IEnumDebugCodeContexts::Reset](../../winscript/reference/ienumdebugcodecontexts-reset.md)|Resetuje sekwencję wyliczenia na początku.|  
|[IEnumDebugCodeContexts::Clone](../../winscript/reference/ienumdebugcodecontexts-clone.md)|Tworzy moduł wyliczający, który zawiera stan tego samego jako bieżący modułu wyliczającego.|