...
Można kontrolować różne aspekty okno interaktywne za pośrednictwem **Narzędzia > Opcje > Narzędzia Python Tools > Windows interakcyjne** (zobacz [opcje](options.md)):
...
> [!Tip]
> Domyślnie program Visual Studio usuwa >>> i... REPL monity podczas wklejania do edytora kodu z okna interaktywnego. To zachowanie można zmienić na **Narzędzia > Opcje > Edytor tekstu > Python > Zaawansowane** karcie przy użyciu **Wklej usuwa monitów REPL** opcji. Zobacz [opcji - różne opcje](options.md#miscellaneous-options).
...
Jeśli to zachowanie jest problem, Zmień ustawienia w obszarze **Narzędzia > Opcje > Narzędzia Python Tools > interakcyjne Windows** w **tryb uzupełniania** grupy, zgodnie z opisem w [opcje — Opcje interakcyjne Windows](options.md#interactive-windows-options).
