...
1. Wybierz lokalizację, w którym można zapisać pliku projektu ( `.pyproj` pliku na dysku). Jeśli to konieczne, możesz również obejmować automatyczne wykrywanie środowisk wirtualnych i dostosować projekt do innej witryny sieci web struktury. Jeśli nie wiesz, z tych opcji, pozostaw je ustawić wartości domyślne.
