---
title: "Praca z języka Python w programie Visual Studio, krok 0 - instalacji | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/01/2017
ms.reviewer: 
ms.suite: 
...
> [!Note]
> Obsługa języka Python jest obecnie dostępna tylko w programie Visual Studio dla systemu Windows; w systemie Mac i Linux Python pomocy technicznej jest dostępna za pośrednictwem programu Visual Studio Code. Zobacz [pytania i odpowiedzi](python-in-visual-studio.md#questions-and-answers).

1. Pobierz i Uruchom najnowszą wersję Instalatora programu Visual Studio 2017 r dla systemu Windows (Obsługa języka Python znajduje się w wersji 15.2 i nowsze).
...
> [!div class="nextstepaction"]
> [Krok 1: Tworzenie projektu języka Python](vs-tutorial-01-01.md)
