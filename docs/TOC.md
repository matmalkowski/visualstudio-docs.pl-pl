...
## [Zmiana lokalizacji instalacji](install/change-installation-locations.md)
## [Rozwiązywanie problemów z instalacją](install/troubleshooting-installation-issues.md)
...
## [Python: tworzenie aplikacji internetowej](ide/quickstart-python.md)
## [Node.js: tworzenie aplikacji internetowej](ide/quickstart-nodejs.md)
## [C#: tworzenie aplikacji internetowej](ide/quickstart-aspnet-core.md)
...
## [Debugowanie w programie Visual Studio](debugger/getting-started-with-the-debugger.md?context=visualstudio/default)
# Przewodniki z instrukcjami
## [Tworzenie aplikacji](ide/index-writing-code.md)
### [Poruszanie się w środowisku IDE](ide/how-to-move-around-in-the-visual-studio-ide.md)
...
##### [Podpisywanie manifestów wdrożenia i aplikacji](ide/how-to-sign-application-and-deployment-manifests.md)
...
##### [Tworzenie szablonów internetowych](ide/how-to-manually-create-web-templates.md)
...
#### [Obsługa architektury 64-bitowej](ide/visual-studio-ide-64-bit-support.md)
...
##### Fragmenty kodu
###### [Używanie fragmentów kodu](ide/code-snippets.md)
####### [Dokumentacja fragmentów kodu w języku C#](ide/visual-csharp-code-snippets.md)
####### [Dokumentacja fragmentów kodu w języku C++](ide/visual-cpp-code-snippets.md)
####### [Wstawianie komentarzy XML](ide/reference/generate-xml-documentation-comments.md)
...
###### [Generowanie klasy/typu](ide/reference/generate-class-type.md)
###### [Generowanie metody](ide/reference/generate-method.md)
###### [Generowanie pola/właściwości/elementu lokalnego](ide/reference/generate-field-property-local.md)
###### [Generowanie konstruktora](ide/reference/generate-constructor.md)
###### [Generowanie zastąpienia](ide/reference/generate-override.md)
###### [Generowanie przesłonięć metod elementu Equals i GetHashCode](ide/reference/generate-equals-gethashcode-methods.md)
###### [Implementowanie klasy abstrakcyjnej](ide/reference/implement-abstract-class.md)
###### [Implementowanie interfejsu](ide/reference/implement-interface.md)
###### [Wprowadzanie zmiennej lokalnej](ide/reference/introduce-local-variable.md)
##### [Refaktoryzacja kodu](ide/refactoring-in-visual-studio.md)
###### [Zmiana sygnatury metody](ide/reference/change-method-signature.md)
###### [Konwertowanie między pętlą for i instrukcją foreach](ide/reference/convert-for-loop-to-foreach.md)
###### [Konwertowanie między właściwością i metodą Get](ide/reference/convert-get-method-to-property.md)
###### [Konwertowanie zapytania LINQ na instrukcję foreach](ide/reference/convert-linq-to-foreach.md)
###### [Hermetyzowanie pola](ide/reference/encapsulate-field.md)
###### [Wyodrębnianie interfejsu](ide/reference/extract-interface.md)
###### [Wyodrębnianie metody](ide/reference/extract-method.md)
###### [Śródwierszowa zmienna tymczasowa](ide/reference/inline-temporary-variable.md)
###### [Przenoszenie deklaracji blisko odwołania](ide/reference/move-declaration-near-reference.md)
###### [Przenoszenie typu do pasującego pliku](ide/reference/move-type-to-matching-file.md)
###### [Usuwanie nieosiągalnego kodu](ide/reference/remove-unreachable-code.md)
###### [Zmiana nazwy](ide/reference/rename.md)
###### [Synchronizacja typu i nazwy pliku](ide/reference/sync-type-and-file.md)
###### [Używanie typu jawnego](ide/reference/convert-var-to-explicit-type.md)
##### [Przewodnik: Generowanie kodu na podstawie użycia](ide/walkthrough-test-first-support-with-the-generate-from-usage-feature.md)
...
###### [Wszystkie skróty klawiaturowe](ide/default-keyboard-shortcuts-in-visual-studio.md)
...
##### [Wyświetlanie definicji typów i elementów członkowskich](ide/go-to-and-peek-definition.md)
###### [Wyświetlanie i edytowanie kodu za pomocą polecenia Zobacz definicję](ide/how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
...
#### [Dostosowywanie paska przewijania](ide/how-to-track-your-code-by-customizing-the-scrollbar.md)
#### [Ustawianie zakładek w kodzie](ide/setting-bookmarks-in-code.md)
#### [Znajdowanie historii kodu za pomocą funkcji CodeLens](ide/find-code-changes-and-other-history-with-codelens.md)
...
### [Projektowanie klas w Projektancie klas](ide/class-designer/designing-and-viewing-classes-and-types.md)
#### [Dodawanie diagramów klas do projektów](ide/class-designer/how-to-add-class-diagrams-to-projects.md)
#### [Dostosowywanie diagramów klas](ide/class-designer/how-to-customize-class-diagrams.md)
#### [Kopiowanie elementów diagramu klas do dokumentu pakietu Microsoft Office](ide/class-designer/how-to-copy-class-diagram-elements-to-a-microsoft-office-document.md)
#### [Eksportowanie diagramów klas jako obrazów](ide/class-designer/how-to-export-class-diagrams-as-images.md)
#### [Drukowanie diagramów klas](ide/class-designer/how-to-print-class-diagrams.md)
#### [Dodawanie komentarzy do diagramów klas](ide/class-designer/how-to-add-comments-to-class-diagrams.md)
#### Tworzenie klas i typów
##### [Tworzenie typów](ide/class-designer/how-to-create-types.md)
##### [Tworzenie dziedziczenia między typami](ide/class-designer/how-to-create-inheritance-between-types.md)
##### [Tworzenie skojarzeń między typami](ide/class-designer/how-to-create-associations-between-types.md)
##### [Wizualizacja skojarzenia kolekcji](ide/class-designer/how-to-visualize-a-collection-association.md)
##### [Tworzenie i konfigurowanie składowych typów](ide/class-designer/creating-and-configuring-type-members.md)
#### Wyświetlanie typów i relacji
##### [Wyświetlanie istniejących typów](ide/class-designer/how-to-view-existing-types.md)
##### [Wyświetlanie dziedziczenia między typami](ide/class-designer/how-to-view-inheritance-between-types.md)
##### [Notacja składowych i notacja skojarzeń](ide/class-designer/how-to-change-between-member-notation-and-association-notation.md)
#### [Refaktoryzacja klas i typów](ide/class-designer/refactoring-classes-and-types.md)
##### [Implementowanie interfejsu](ide/class-designer/how-to-implement-an-interface.md)
##### [Podział klasy na klasy częściowe](ide/class-designer/how-to-split-a-class-into-partial-classes.md)
##### [Tworzenie typu dopuszczającego wartość null](ide/class-designer/how-to-create-a-nullable-type.md)
#### [Praca z kodem w języku Visual C++](ide/class-designer/working-with-visual-cpp-code.md)
##### [Klasy języka C++](ide/class-designer/visual-cpp-classes.md)
##### [Struktury języka C++](ide/class-designer/visual-cpp-structures.md)
##### [Wyliczenia języka C++](ide/class-designer/visual-cpp-enumerations.md)
##### [Definicje typów języka C++](ide/class-designer/visual-cpp-typedefs.md)
#### [Skróty klawiatury i myszy](ide/class-designer/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window.md)
#### [Błędy Projektanta klas](ide/class-designer/additional-information-about-errors.md)
### [Ulepszanie kodu](ide/find-and-fix-code-errors.md)
...
### [Programowanie aplikacji pakietu Office i programu SharePoint](vsto/office-and-sharepoint-development-in-visual-studio.md)
...
### [Konfiguracje kompilacji](ide/understanding-build-configurations.md)
...
### [Platformy kompilacji](ide/understanding-build-platforms.md)
...
### [Dostosowywanie menu i pasków narzędzi](ide/how-to-customize-menus-and-toolbars-in-visual-studio.md)
...
## [Optymalizacja wydajności](ide/optimize-visual-studio-performance.md)
### [Czas uruchamiania](ide/optimize-visual-studio-startup-time.md)
...
### [Utrzymywanie zabezpieczeń](ide/maintaining-security.md)
### [Uprawnienia użytkownika](ide/user-permissions-and-visual-studio.md)
...
### [Informacje o bieżącej wersji](/visualstudio/releasenotes/vs2017-relnotes?context=visualstudio/default)
### [Informacje o wersji zapoznawczej](/visualstudio/releasenotes/vs2017-preview-relnotes?context=visualstudio/default)
### [Historia informacji o wersji](/visualstudio/releasenotes/vs2017-relnotes-history?context=visualstudio/default)
### [Rytm wydawania](/visualstudio/productinfo/vs2017-release-rhythm?context=visualstudio/default)
### [Wymagania systemowe](/visualstudio/productinfo/vs2017-system-requirements-vs?context=visualstudio/default)
### [Zgodność platformy](/visualstudio/productinfo/vs2017-compatibility-vs?context=visualstudio/default)
### [Licencjonowanie](https://www.visualstudio.com/license-terms/)
### [Kod dystrybucyjny](/visualstudio/productinfo/2017-redistribution-vs?context=visualstudio/default)
### [Cykl życia pomocy technicznej i obsługi](/visualstudio/productinfo/vs-servicing-vs?context=visualstudio/default)
## [Zgłaszanie problemu z programem Visual Studio](ide/how-to-report-a-problem-with-visual-studio-2017.md)
## [Program poprawy jakości obsługi programu Visual Studio](ide/visual-studio-experience-improvement-program.md)
