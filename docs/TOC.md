...
#### [Używanie środowiska IDE dla języka VB...](vb-ide/refactoring-vb.md)
#### [Refaktoryzacja, generowanie kodu i szybkie akcje](ide/refactoring-code-generation-quick-actions.md)
...
##### [Konwencje dotyczące formatowania i języka .NET dla wtyczki EditorConfig](ide/editorconfig-code-style-settings-reference.md)
##### [Konwencje nazewnictwa języka .NET dla wtyczki EditorConfig](ide/editorconfig-naming-conventions.md)
...
#### [Tworzenie pakietów startowych](ide/how-to-create-starter-kits.md)
