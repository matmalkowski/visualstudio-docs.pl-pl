...
Zakładki służy do oznaczania wierszy w kodzie, dzięki czemu można szybko powrócić do określonej lokalizacji i przeskakiwanie między lokalizacjami.  
  
 Zakładka polecenia i ikony są dostępne w dwóch miejscach: okno zakładek (**okno widoku/zakładki**) i paska narzędzi edytora tekstu.  
