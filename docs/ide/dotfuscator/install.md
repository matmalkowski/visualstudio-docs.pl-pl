---
title: Zainstaluj Dotfuscator Community Edition (CE)
ms.date: 06/22/2017
ms.devlang: dotnet
...
ms.locfileid: "33704853"
---
# <a name="install-dotfuscator-community-edition-ce"></a>Zainstaluj Dotfuscator Community Edition (CE)

Visual Studio 2017 wprowadza nową funkcjonalność instalacji o niskim znaczeniu.
W związku z tym Dotfuscator Community Edition (Dotfuscator CE) nie jest instalowany domyślnie.
Jednak jest łatwo zainstalować Dotfuscator CE, nawet jeśli jest już zainstalowany program Visual Studio.
