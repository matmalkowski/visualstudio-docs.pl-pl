...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Wyjaśniono, jak zlokalizowanych zasobów są przechowywane i dostępne w programie Visual Studio.  
  
 [Zabezpieczenia a zlokalizowane zestawy satelickie](../ide/security-and-localized-satellite-assemblies.md)  
 W tym artykule omówiono podpisywania zestawy satelickie z par kluczy publicznych i prywatnych.  
