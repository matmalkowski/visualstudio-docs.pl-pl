...
|----------|----------|--------------------------|  
|Instalacja|Zainstaluj program Visual Studio.|[Zainstaluj program Visual Studio](../install/install-visual-studio.md)|  
...
|Kompilowanie|Używanie zdarzeń mających miejsce po kompilacji, które rejestrują składnik.|[Opis niestandardowe kroki procesu kompilacji lub zdarzeniach kompilacji](/cpp/ide/understanding-custom-build-steps-and-build-events)|  
||Włączanie etapu rejestracji podczas kompilowania projektów języka C++.|[Opis niestandardowe kroki procesu kompilacji lub zdarzeniach kompilacji](/cpp/ide/understanding-custom-build-steps-and-build-events)|  
