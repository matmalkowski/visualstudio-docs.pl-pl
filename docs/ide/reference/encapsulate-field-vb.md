---
title: "Refaktoryzuj pola do właściwości w języku Visual Basic | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
1. Zaznacz lub umieść kursor tekst wewnątrz Nazwa pola w celu hermetyzacji:
   ...
   ![Wyróżniony kod](media/encapsulate-highlight-vb.png)
...
1. Następnie wykonaj jedną z następujących czynności:
   ...
   **Hermetyzuj pola (ale nadal używaj pola)** | Hermetyzuje pola z właściwością, ale pozostawia niezmienionej użycia wszystkie pola
   ...
   ![Hermetyzuj wynik właściwości](media/encapsulate-result-vb.png)
