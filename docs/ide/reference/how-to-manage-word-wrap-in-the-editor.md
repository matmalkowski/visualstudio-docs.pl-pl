---
title: "Porady: Zarządzanie zawijaniem wierszy w edytorze | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
2.  W **Edytor tekstu** folderu, wybierz **ogólne** opcje w **wszystkie języki** podfolderu, aby ustawić tę opcję, globalnie.  
...
3.  W obszarze **ustawienia**, zaznacz lub wyczyść **zawijanie** opcji.  
     ...
     Gdy **zawijanie** wybrano opcję **Pokaż zualne przy zawijaniu wierszy** opcja jest włączona.  
  
4.  Wybierz **Pokaż zualne dla zawijania** opcję, aby wyświetlić wskaźnik Strzałka powrotu, gdzie długi wiersz jest zawijana wokół drugi wiersz. Usuń zaznaczenie tej opcji, jeśli nie chcesz wyświetlić strzałki wskaźnika.  
