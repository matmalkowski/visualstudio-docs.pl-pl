...
Aby uzyskać więcej informacji na temat typów plików w projektach C++, zobacz [pliku typy utworzone dla projektów Visual C++](/cpp/ide/file-types-created-for-visual-cpp-projects) i [Unicode w programie Microsoft Foundation Class Library](/cpp/mfc/unicode-in-mfc)
