---
title: "Wyodrębnij interfejs w języku C# | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
1. W **wyodrębniania interfejsu** okno dialogowe, które pojawia się, wprowadź informacje zadawane: ![Wyodrębnij Interface](media/extractinterface-dialog-cs.png)
   | Pole | Opis |
   | --- | --- |
...
1. Kliknij przycisk **OK**.
   ...
   ![Wynikowa klasy](media/extractinterface-class-cs.png)
   ![wynikowy — interfejs](media/extractinterface-interface-cs.png)
