...
Domyślnie, aby wyłączyć optymalizacje kompilatora to pole wyboru jest wyczyszczone. Zaznacz to pole wyboru, aby włączyć optymalizacje kompilatora. Mniejszy, szybszy i bardziej wydajne, plik wyjściowy był optymalizacje kompilatora. Jednak ponieważ optymalizacje modyfikacji kodu w pliku wyjściowym, optymalizacje kompilatora może utrudnić debugowania.
 ...
 **Generowanie informacji o debugowaniu**
 ...
 Wybierz **Brak**, **pełne**, lub **tylko do pdb** z listy. **Brak** Określa, czy można wygenerować żadnych informacji debugowania. **Pełna** określa wygenerowania pełne informacje o debugowaniu, i **tylko do pdb** Określa, czy mają być generowane tylko plik PDB informacji o debugowaniu. Wartość domyślna dla tej opcji to **pełne**.
