---
title: "Produktów i usług firmy Microsoft | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 08/22/2017
ms.reviewer: 
ms.suite: 
...
### <a name="free-step-by-step-tutorials"></a>Bezpłatne samouczki krok po kroku  
 ...
 Aby znaleźć samouczki krok po kroku dotyczące produktów firmy Microsoft, zobacz [witryny sieci Web Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkId=8431).  

### <a name="assistive-technology-products-for-windows"></a>Produkty technologii pomocniczej dla systemu Windows  
 Firma Microsoft oferuje szeroki asortyment produktów technologii pomocniczej, które ułatwiają posługiwanie się komputerem przez osoby niepełnosprawne. Możesz przeszukać wykaz produktów technologii pomocniczej, które działają w systemie Windows w [witryny sieci Web Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkId=8431).  
...
##  <a name="moreinfo"></a>Aby uzyskać więcej informacji  
 Aby uzyskać więcej informacji o tym jak przystępna technika komputerowa pomaga w polepszaniu życia osób niepełnosprawnych, zobacz [witryny sieci Web Microsoft Accessibility](http://go.microsoft.com/fwlink/?LinkId=8431).  
