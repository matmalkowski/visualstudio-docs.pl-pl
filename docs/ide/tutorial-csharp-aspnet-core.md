---
title: Wprowadzenie do języka C# i ASP.NET Core w programie Visual Studio | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 12/11/2017
ms.reviewer: ''
ms.suite: ''
...
1. Visual Studio uruchamia okno przeglądarki. Wybierz **o**.
...
1. Zmiana tekstu **"dodatkowe"** do **"zmienione"** i Zapisz plik.
