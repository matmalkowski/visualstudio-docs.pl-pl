...
## <a name="related-sections"></a>Sekcje pokrewne  
 [Globalizowanie aplikacji (HTML)](http://go.microsoft.com/fwlink/?LinkId=258266)  
 Zawiera tematy instruktażowe i wskazówki ułatwiające globalize i lokalizowanie Windows 8.1 aplikacji skompilowanej za pomocą HTML.  
