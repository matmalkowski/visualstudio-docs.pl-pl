...
-   Aby przejść do następnego kroku samouczka, zobacz [krok 8: Dodawanie metody, aby sprawdzić, czy gracz wygrał](../ide/step-8-add-a-method-to-verify-whether-the-player-won.md).  
