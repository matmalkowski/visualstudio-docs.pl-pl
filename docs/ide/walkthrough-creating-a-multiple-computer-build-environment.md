...
-   Z licencjonowanej kopii programu Visual Studio Ultimate, Visual Studio Premium lub Visual Studio Professional  
  
-   Kopia programu .NET Framework 4.5.1, który można pobrać z [programu Visual Studio](http://www.microsoft.com/visualstudio/eng/downloads#d-additional-software) witryny sieci Web.  
...
2.  Skopiuj następujące rekursywnie folderów z komputera hosta na komputerze kompilacji:  
    ...
    -   %ProgramFiles%\Microsoft 11.0\VC\ programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\Tools\ProjectComponents\ programu visual Studio  
...
3.  Skopiuj następujące pliki z komputera hosta na komputerze kompilacji:  
    ...
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\msobj110.dll programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\mspdb110.dll programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\mspdbcore.dll programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\mspdbsrv.exe programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\msvcdis110.dll programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\Tools\makehm.exe programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\Tools\VCVarsQueryRegistry.bat programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\Tools\vsvars32.bat programu visual Studio  
...
1.  Aby ręcznie skonfigurować środowiska wiersza polecenia, Dodaj tę ścieżkę do zmiennej środowiskowej PATH:  
    ...
    -   % Program Files%\Microsoft programu Visual Studio 11.0\Common7\IDE  
...
2.  Opcjonalnie można również Dodaj następujące ścieżki do zmiennej PATH, aby ułatwić Użyj programu MSBuild do tworzenia rozwiązań.  
    ...
    -   % Program Files%\Microsoft SDKs\Windows\v8.0A\bin\NETFX 4.0 narzędzia  
...
#### <a name="to-copy-assemblies-from-the-host-computer-and-install-them-on-the-build-computer"></a>Aby skopiować zestawy z komputera hosta i zainstalowania go na komputerze kompilacji  
...
1.  Skopiuj następujące zestawy z komputera hosta na komputerze kompilacji. Ponieważ zostaną zainstalowane w GAC, nie ma znaczenia, gdzie umieścić je na komputerze kompilacji.  
    ...
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\CommonExtensions\Microsoft\VC\Project\Microsoft.VisualStudio.Project.VisualC.VCProjectEngine.dll programu visual Studio  
  
    -   %ProgramFiles%\Microsoft 11.0\Common7\IDE\PublicAssemblies\Microsoft.VisualStudio.VCProjectEngine.dll programu visual Studio  
...
#### <a name="to-create-a-build-environment-that-can-be-checked-into-source-control"></a>Aby utworzyć środowisko kompilacji, który może być wyewidencjonowany do kontroli źródła  
