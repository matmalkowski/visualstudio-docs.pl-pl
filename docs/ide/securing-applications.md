...
## <a name="general-security-considerations"></a>Zagadnienia dotyczące zabezpieczeń  
 ...
 [Bezpieczeństwo i programowania (C# i Visual Basic)](https://msdn.microsoft.com/en-us/library/ms233782(v=vs.100).aspx)  
...
## <a name="securing-mobile-applications"></a>Zabezpieczanie aplikacji mobilnych  
 ...
 [Cele zabezpieczeń dla programu .NET Compact Framework](http://msdn.microsoft.com/en-us/64ac2770-e2bc-40a3-abbf-56c8a2c0e364)  
 W tym artykule opisano cele dotyczące zabezpieczeń .NET Compact Framework.  
  
 [Projektowanie bezpiecznego przenośnych formularza strony](http://msdn.microsoft.com/en-us/b69727c1-f81f-4221-a116-8f92f769365f)  
...
## <a name="securing-web-applications"></a>Zabezpieczanie aplikacji sieci Web  
 ...
 Zawiera szczegóły dotyczące niektórych problemów zabezpieczeń, które mogą wystąpić programistów języka JScript.  
  
 [Porady: Korzystanie z zabezpieczeń transportu](http://msdn.microsoft.com/en-us/16210e41-5492-4cc8-9002-7366b1fc7297)  
