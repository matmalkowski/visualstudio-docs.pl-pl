...
-   [Identyfikowanie skrótów klawiaturowych](../ide/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md#bkmk_identify)  
  
-   [Dostosowywanie skrótów klawiaturowych](../ide/identifying-and-customizing-keyboard-shortcuts-in-visual-studio.md#bkmk_assign)  
...
##  <a name="bkmk_identify"></a>Identyfikowanie skrótów klawiaturowych  
...
##  <a name="bkmk_assign"></a>Dostosowywanie skrótów klawiaturowych  
...
5.  W **Użyj nowego skrótu w** wybierz obszaru funkcji, w której chcesz użyć skrótu.  
