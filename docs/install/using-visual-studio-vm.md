...
* [Utwórz maszynę Wirtualną za pośrednictwem portalu Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/quick-create-portal)
* [Maszyn wirtualnych systemu Windows — omówienie](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/overview)