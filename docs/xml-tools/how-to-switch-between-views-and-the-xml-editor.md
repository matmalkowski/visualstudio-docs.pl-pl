...
1.  Do tworzenia i edytowania nowy plik schematu XML, postępuj zgodnie z instrukcjami [porady: tworzenie i edytowanie pliku schematu XSD](../xml-tools/how-to-create-and-edit-an-xsd-schema-file.md).

2.  Aby przełączyć się do projektanta schematu XML w edytorze XML, kliknij prawym przyciskiem myszy dowolne miejsce w edytorze XML, a następnie wybierz **Widok projektanta**.
...
5.  Aby przełączyć się do widoku startowego z widoku modelu zawartości za pomocą narzędzi, kliknij przycisk Start widoku na pasku narzędzi XSD.

6.  Aby przełączyć się między widokami za pomocą klawiszy dostępu, naciśnij klawisze CTRL + 1 dla widoku startowego, CTRL + 2 dla widoku wykresu i CTRL + 3 dla widoku modelu zawartości.
