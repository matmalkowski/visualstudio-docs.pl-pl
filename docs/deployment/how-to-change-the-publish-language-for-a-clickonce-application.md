---
title: 'Porady: Zmienianie języka publikacji dla aplikacji ClickOnce | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
Podczas publikowania [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] aplikacji, interfejs użytkownika podczas instalacji, wartością domyślną będzie języka i kultury komputerze dewelopera. W przypadku publikowania zlokalizowanej aplikacji, należy określić języka i kultury odpowiadające zlokalizowanej wersji. Jest to określane za pomocą `Publish language` właściwości projektu.  
 ...
 `Publish language` Właściwości można ustawić w **opcji publikowania** okno dialogowe, dostępne z **publikowania** strony **projektanta projektu**.  
...
### <a name="to-change-the-publish-language"></a>Aby zmienić język publikowania  
...
5.  W **opcji publikowania** okno dialogowe pola, wybierz język i kultury z **języka publikacji** listy rozwijanej, a następnie kliknij przycisk **OK**.  
