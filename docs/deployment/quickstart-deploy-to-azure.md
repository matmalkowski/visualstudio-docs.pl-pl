...
- [Wdrażanie aplikacji platformy ASP.NET Core w systemie Azure](https://docs.microsoft.com/en-us/aspnet/core/tutorials/publish-to-azure-webapp-using-vs)
- [Ciągłe wdrażanie platformy ASP.NET Core na platformie Azure za pomocą narzędzia Git](https://docs.microsoft.com/en-us/aspnet/core/publishing/azure-continuous-deployment)
