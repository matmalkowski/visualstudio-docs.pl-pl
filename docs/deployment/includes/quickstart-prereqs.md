...
* [Visual Studio 2017](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017) zainstalowane z obciążeniami odpowiednie dla Twojej języka:
  ...
  * Python: **programowania Python**
  * Node.js: **programowanie Node.js**

* Projekt platformy ASP.NET Core, .NET Core, Python lub Node.js. Jeśli nie masz już projekt, wybierz opcję poniżej:
  ...
  * Python: Wykonaj [Szybki Start: tworzenie pierwszej aplikacji sieci web platformy Python za pomocą programu Visual Studio](../../ide/quickstart-python.md), lub użyj **pliku** > **nowy projekt**, wybierz pozycję **języka Python** , a następnie wybierz pozycję **projektu sieci Web platformy Flask**.
