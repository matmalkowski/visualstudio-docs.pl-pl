...
2. Następnie zainstaluj 3,6 wdrażania w sieci Web do obsługi serwerów w systemie Windows Server.
...
3. W systemie Windows Server, przejdź do **Wybieranie ról serwera** > **serwer sieci Web (IIS)** > **narzędzia do zarządzania**, a następnie wybierz **usług IIS Narzędzia i skrypty zarządzania** roli, kliknij przycisk **dalej**, a następnie zainstaluj rolę.

    ![Zainstaluj narzędzia i skrypty zarządzania usługami IIS](../../deployment/media/tutorial-iis-management-scripts-and-tools.png)

    Ta rola jest wymagana, aby umożliwić wygenerowanie pliku ustawień publikowania.

4. Sprawdź, czy narzędzie Web Deploy działa poprawnie, otwierając **Panel sterowania > System i Zabezpieczenia > Narzędzia administracyjne > usługi** i upewnij się, że **Usługa agenta sieci Web wdrożenia** działa ( Nazwa usługi jest inny w starszych wersjach).
