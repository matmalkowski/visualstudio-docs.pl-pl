---
title: ClickOnce — odwołanie | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Zawiera łącza do odwołania dokumentacji publicznej klasy, które obsługuje technologii ClickOnce w kodzie zarządzanym.  
  
 [Publikowanie aplikacji ClickOnce](../deployment/publishing-clickonce-applications.md)  
 Zawiera wskazówki i w jaki sposób — do firmy który zadań ClickOnce.