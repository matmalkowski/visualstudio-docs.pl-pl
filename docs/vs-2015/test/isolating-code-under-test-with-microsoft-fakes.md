...
Najnowszą wersję tego tematu znajduje się w temacie [izolując kod w ramach testu, with Microsoft Fakes](https://docs.microsoft.com/visualstudio/test/isolating-code-under-test-with-microsoft-fakes).  
