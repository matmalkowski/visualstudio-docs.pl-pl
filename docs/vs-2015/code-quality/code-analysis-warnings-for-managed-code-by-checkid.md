...
Najnowszą wersję tego tematu znajduje się w temacie [ostrzeżenia analizy kodu dla zarządzanego kodu dzięki CheckId](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-warnings-for-managed-code-by-checkid).  
