...
ms.locfileid: "42680312"
---
# <a name="interoperability-warnings"></a>Współdziałanie — Ostrzeżenia
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ostrzeżenia dotyczące współdziałania](https://docs.microsoft.com/visualstudio/code-quality/interoperability-warnings).  
