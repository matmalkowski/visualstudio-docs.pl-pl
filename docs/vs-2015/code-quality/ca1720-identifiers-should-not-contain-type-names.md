...
ms.locfileid: "42630968"
---
# <a name="ca1720-identifiers-should-not-contain-type-names"></a>CA1720: Identyfikatory nie powinny zawierać nazw typów
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [CA1720: identyfikatory nie powinny zawierać nazw typów](https://docs.microsoft.com/visualstudio/code-quality/ca1720-identifiers-should-not-contain-type-names).  
  
Element TypeName | IdentifiersShouldNotContainTypeNames |  
| CheckId | CA1720 |  
