...
ms.locfileid: "42683085"
---
# <a name="how-to-display-thread-properties"></a>Porady: wyświetlanie właściwości wątku
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [porady: wyświetlanie właściwości wątku](https://docs.microsoft.com/visualstudio/debugger/how-to-display-thread-properties).  
