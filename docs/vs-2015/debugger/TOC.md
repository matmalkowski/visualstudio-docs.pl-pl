...
### [Błąd: Zapora na maszynie zdalnej](error-firewall-on-local-machine.md)
...
### [Instrukcje: debugowanie hostowanej samodzielnie usługi WCF](how-to-debug-a-self-hosted-wcf-service.md)
