...
Najnowszą wersję tego tematu znajduje się w temacie [idiasession::findsymbolbyrvaex —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasession-findsymbolbyrvaex).  
