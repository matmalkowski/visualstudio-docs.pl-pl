...
ms.locfileid: "42681084"
---
# <a name="idiatablegetnewenum"></a>IDiaTable::get__NewEnum
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [idiatable::get__newenum —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiatable-get-newenum).  
