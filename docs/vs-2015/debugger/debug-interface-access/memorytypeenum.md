...
ms.locfileid: "42688698"
---
# <a name="memorytypeenum"></a>MemoryTypeEnum
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [memorytypeenum —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/memorytypeenum).  
