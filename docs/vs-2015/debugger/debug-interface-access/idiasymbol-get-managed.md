...
Najnowszą wersję tego tematu znajduje się w temacie [idiasymbol::get_managed —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-managed).  
