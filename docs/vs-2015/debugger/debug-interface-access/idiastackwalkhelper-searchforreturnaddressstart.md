...
Najnowszą wersję tego tematu znajduje się w temacie [idiastackwalkhelper::searchforreturnaddressstart —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiastackwalkhelper-searchforreturnaddressstart).  
