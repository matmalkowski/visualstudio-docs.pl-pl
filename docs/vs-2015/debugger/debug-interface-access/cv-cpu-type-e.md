...
ms.locfileid: "42674822"
---
# <a name="cvcputypee"></a>CV_CPU_TYPE_e
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [cv_cpu_type_e —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/cv-cpu-type-e).  
