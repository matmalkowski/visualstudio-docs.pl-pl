...
ms.locfileid: "42685631"
---
# <a name="functionargtype"></a>FunctionArgType
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [functionargtype —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/functionargtype).  
