...
Najnowszą wersję tego tematu znajduje się w temacie [idiasymbol::get_virtualbasepointeroffset —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-virtualbasepointeroffset).  
