...
ms.locfileid: "42682938"
---
# <a name="dia2dumpcpp-source-file"></a>Plik źródłowy Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [plik źródłowy Dia2dump.cpp](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/dia2dump-cpp-source-file).  
