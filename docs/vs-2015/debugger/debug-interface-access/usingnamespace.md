...
ms.locfileid: "42685540"
---
# <a name="usingnamespace"></a>UsingNameSpace
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [usingnamespace —](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/usingnamespace).  
