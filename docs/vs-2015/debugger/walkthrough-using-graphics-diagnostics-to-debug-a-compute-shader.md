...
Najnowszą wersję tego tematu znajduje się w temacie [Instruktaż: za pomocą Graphics Diagnostics do debugowania cieniowania obliczenia](https://docs.microsoft.com/visualstudio/debugger/graphics/walkthrough-using-graphics-diagnostics-to-debug-a-compute-shader).  
