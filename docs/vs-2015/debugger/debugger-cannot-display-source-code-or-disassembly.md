...
Najnowszą wersję tego tematu znajduje się w temacie [kodu debuger nie wyświetlania źródłowego lub dezasemblacji](https://docs.microsoft.com/visualstudio/debugger/debugger-cannot-display-source-code-or-disassembly).  
