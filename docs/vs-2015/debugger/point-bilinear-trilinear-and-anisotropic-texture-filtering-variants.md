...
Najnowszą wersję tego tematu znajduje się w temacie [punkt dwuliniowa Trilinear i wariantów Anizotropowego filtrowania tekstur](https://docs.microsoft.com/visualstudio/debugger/graphics/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants).  
