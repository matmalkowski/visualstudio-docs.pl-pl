...
ms.locfileid: "42676664"
---
# <a name="cvwritemessage-function"></a>CvWriteMessage — Funkcja
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [funkcja CvWriteMessage](https://docs.microsoft.com/visualstudio/profiling/cvwritemessage-function).  
