...
ms.locfileid: "42690809"
---
# <a name="cvwriteflag-function"></a>CvWriteFlag — Funkcja
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [funkcja CvWriteFlag](https://docs.microsoft.com/visualstudio/profiling/cvwriteflag-function).  
