...
ms.locfileid: "42633917"
---
# <a name="cores-view-logical-cores"></a>Widok rdzeni — Rdzenie logiczne
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [widok rdzeni — rdzenie logiczne](https://docs.microsoft.com/visualstudio/profiling/cores-view-logical-cores).  
