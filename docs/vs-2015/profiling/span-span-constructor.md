...
ms.locfileid: "42683927"
---
# <a name="spanspan-constructor"></a>span::span — Konstruktor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Konstruktor span::span](https://docs.microsoft.com/visualstudio/profiling/span-span-constructor).  
