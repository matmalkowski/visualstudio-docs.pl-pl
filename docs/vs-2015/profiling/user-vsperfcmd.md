...
ms.locfileid: "42692291"
---
# <a name="user-vsperfcmd"></a>Użytkownik (VSPerfCmd)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [użytkownik (VSPerfCmd)](https://docs.microsoft.com/visualstudio/profiling/user-vsperfcmd).  
