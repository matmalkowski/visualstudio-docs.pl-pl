...
ms.locfileid: "42681641"
---
# <a name="memory-usage-without-debugging"></a>Użycie pamięci bez debugowania
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Analizowanie użycia pamięci bez debugera programu Visual Studio](https://docs.microsoft.com/visualstudio/profiling/memory-usage-without-debugging2).  
