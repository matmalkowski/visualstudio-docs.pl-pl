...
ms.locfileid: "42694059"
---
# <a name="cvwritealert-function"></a>CvWriteAlert — Funkcja
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [funkcja CvWriteAlert](https://docs.microsoft.com/visualstudio/profiling/cvwritealert-function).  
