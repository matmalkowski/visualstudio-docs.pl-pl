...
ms.locfileid: "42678948"
---
# <a name="cvleavespan-function"></a>CvLeaveSpan — Funkcja
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [funkcja CvLeaveSpan](https://docs.microsoft.com/visualstudio/profiling/cvleavespan-function).  
