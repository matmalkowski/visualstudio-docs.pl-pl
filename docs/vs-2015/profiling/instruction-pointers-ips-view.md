...
ms.locfileid: "42630072"
---
# <a name="instruction-pointers-ips-view"></a>Widok wskaźników instrukcji (IP)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [widok wskaźników instrukcji (IP)](https://docs.microsoft.com/visualstudio/profiling/instruction-pointers-ips-view).  
