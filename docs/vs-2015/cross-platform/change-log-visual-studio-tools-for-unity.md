...
ms.locfileid: "42691605"
---
# <a name="change-log-visual-studio-tools-for-unity"></a>Dziennik zmian (Visual Studio Tools for Unity)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [dziennik zmian (Visual Studio Tools for Unity)](https://docs.microsoft.com/visualstudio/cross-platform/change-log-visual-studio-tools-for-unity).  
