...
ms.locfileid: "42670210"
---
# <a name="ltpackagefilesgt-element-bootstrapper"></a>&lt;Zadaniach PackageFiles&gt; — Element (program inicjujący)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ &lt;zadaniach PackageFiles&gt; — Element (program inicjujący)](https://docs.microsoft.com/visualstudio/deployment/packagefiles-element-bootstrapper).  
