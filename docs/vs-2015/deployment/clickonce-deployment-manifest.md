...
ms.locfileid: "42630852"
---
# <a name="clickonce-deployment-manifest"></a>Manifest wdrożenia ClickOnce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Manifest wdrażania ClickOnce](https://docs.microsoft.com/visualstudio/deployment/clickonce-deployment-manifest).  
