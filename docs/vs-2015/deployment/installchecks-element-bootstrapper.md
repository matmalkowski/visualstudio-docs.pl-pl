...
ms.locfileid: "42696979"
---
# <a name="ltinstallchecksgt-element-bootstrapper"></a>&lt;InstallChecks&gt; — Element (program inicjujący)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ &lt;InstallChecks&gt; — Element (program inicjujący)](https://docs.microsoft.com/visualstudio/deployment/installchecks-element-bootstrapper).  
