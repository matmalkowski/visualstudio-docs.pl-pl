...
ms.locfileid: "42629900"
---
# <a name="ltdependencygt-element-clickonce-application"></a>&lt;zależność&gt; — Element (aplikacja ClickOnce)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ &lt;zależności&gt; — Element (aplikacja ClickOnce)](https://docs.microsoft.com/visualstudio/deployment/dependency-element-clickonce-application).  
