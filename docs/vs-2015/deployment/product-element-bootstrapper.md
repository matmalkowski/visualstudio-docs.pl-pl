...
ms.locfileid: "42680273"
---
# <a name="ltproductgt-element-bootstrapper"></a>&lt;Produkt&gt; — Element (program inicjujący)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ &lt;produktu&gt; — Element (program inicjujący)](https://docs.microsoft.com/visualstudio/deployment/product-element-bootstrapper).  
