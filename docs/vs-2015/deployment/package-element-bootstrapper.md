...
ms.locfileid: "42677916"
---
# <a name="ltpackagegt-element-bootstrapper"></a>&lt;Pakiet&gt; — Element (program inicjujący)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ &lt;pakietu&gt; — Element (program inicjujący)](https://docs.microsoft.com/visualstudio/deployment/package-element-bootstrapper).  
