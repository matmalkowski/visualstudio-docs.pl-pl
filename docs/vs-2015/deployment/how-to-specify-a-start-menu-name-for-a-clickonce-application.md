...
Najnowszą wersję tego tematu znajduje się w temacie [porady: Określanie nazwy Menu Start dla aplikacji ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-specify-a-start-menu-name-for-a-clickonce-application).  
