...
Najnowszą wersję tego tematu znajduje się w temacie [wskazówki dotyczące narzędzi architektury Studio Visual](https://docs.microsoft.com/visualstudio/modeling/visual-studio-architecture-tooling-guidance).  
