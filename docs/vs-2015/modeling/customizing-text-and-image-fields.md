...
ms.locfileid: "42685561"
---
# <a name="customizing-text-and-image-fields"></a>Dostosowywanie pól tekstowych i obrazu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Dostosowywanie tekst i pola obrazu](https://docs.microsoft.com/visualstudio/modeling/customizing-text-and-image-fields).  
