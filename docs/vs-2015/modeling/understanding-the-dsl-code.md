...
ms.locfileid: "42681394"
---
# <a name="understanding-the-dsl-code"></a>Znajomość kodu DSL
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [znajomość kodu DSL](https://docs.microsoft.com/visualstudio/modeling/understanding-the-dsl-code).  
