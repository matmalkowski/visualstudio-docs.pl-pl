...
Najnowszą wersję tego tematu znajduje się w temacie [wskazówki: debugowanie szablonu tekstowego uzyskującego dostęp do modelu](https://docs.microsoft.com/visualstudio/modeling/walkthrough-debugging-a-text-template-that-accesses-a-model).  
