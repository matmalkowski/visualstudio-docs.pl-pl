...
Najnowszą wersję tego tematu znajduje się w temacie [wskazówki: generowanie kodu przy użyciu szablonów tekstowych](https://docs.microsoft.com/visualstudio/modeling/walkthrough-generating-code-by-using-text-templates).  
