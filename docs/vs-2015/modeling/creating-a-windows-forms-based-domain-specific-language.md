...
Najnowszą wersję tego tematu znajduje się w temacie [Tworzenie języka specyficznego dla domeny Windows Forms-Based](https://docs.microsoft.com/visualstudio/modeling/creating-a-windows-forms-based-domain-specific-language).  
