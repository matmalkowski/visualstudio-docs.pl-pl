...
ms.locfileid: "42676554"
---
# <a name="customizing-copy-behavior"></a>Dostosowywanie zachowania dotyczącego kopiowania
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Dostosowywanie zachowania dotyczącego kopiowania](https://docs.microsoft.com/visualstudio/modeling/customizing-copy-behavior).  
