...
ms.locfileid: "42680008"
---
# <a name="options-text-editor-all-languages"></a>Opcje, edytor tekstu, wszystkie języki
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [opcje, Edytor tekstu wszystkie języki](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-all-languages).  
