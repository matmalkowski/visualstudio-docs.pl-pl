...
ms.locfileid: "42678662"
---
# <a name="set-current-stack-frame-command"></a>Ustaw bieżącą ramkę stosu — Polecenie
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Ustaw bieżący ramkę stosu — polecenie](https://docs.microsoft.com/visualstudio/ide/reference/set-current-stack-frame-command).  
