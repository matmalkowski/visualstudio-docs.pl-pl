...
ms.locfileid: "42681670"
---
# <a name="designing-xaml-in-visual-studio"></a>Projektowanie XAML w programie Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [projektowanie XAML w programie Visual Studio](https://docs.microsoft.com/visualstudio/designers/designing-xaml-in-visual-studio).  
