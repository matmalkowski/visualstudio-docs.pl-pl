...
ms.locfileid: "42681129"
---
# <a name="bitmaps-element"></a>Bitmaps, element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Bitmaps, Element](https://docs.microsoft.com/visualstudio/extensibility/bitmaps-element).  
