...
ms.locfileid: "42681479"
---
# <a name="exposing-properties-to-the-properties-window"></a>Uwidacznianie właściwości w oknie właściwości
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Uwidacznianie właściwości w oknie właściwości](https://docs.microsoft.com/visualstudio/extensibility/exposing-properties-to-the-properties-window).  
