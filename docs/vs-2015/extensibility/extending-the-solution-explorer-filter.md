...
ms.locfileid: "42680263"
---
# <a name="extending-the-solution-explorer-filter"></a>Rozszerzanie filtru Eksploratora rozwiązań
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [rozszerzanie filtru Eksploratora rozwiązań](https://docs.microsoft.com/visualstudio/extensibility/extending-the-solution-explorer-filter).  
