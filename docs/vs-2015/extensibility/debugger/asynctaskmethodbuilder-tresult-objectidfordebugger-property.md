...
Najnowszą wersję tego tematu znajduje się w temacie [AsyncTaskMethodBuilder&lt;TResult&gt;. Właściwość ObjectIdForDebugger](https://docs.microsoft.com/visualstudio/extensibility/debugger/asynctaskmethodbuilder-tresult-objectidfordebugger-property).  
