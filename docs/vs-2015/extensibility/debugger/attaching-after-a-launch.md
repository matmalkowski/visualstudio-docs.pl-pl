...
ms.locfileid: "42634075"
---
# <a name="attaching-after-a-launch"></a>Dołączanie po uruchomieniu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [dołączanie po Uruchom](https://docs.microsoft.com/visualstudio/extensibility/debugger/attaching-after-a-launch).  
