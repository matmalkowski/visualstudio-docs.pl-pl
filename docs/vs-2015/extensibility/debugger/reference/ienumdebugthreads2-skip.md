...
ms.locfileid: "42684112"
---
# <a name="ienumdebugthreads2skip"></a>IEnumDebugThreads2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [IEnumDebugThreads2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugthreads2-skip).  
