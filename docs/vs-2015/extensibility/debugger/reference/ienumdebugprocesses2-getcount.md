...
ms.locfileid: "42633486"
---
# <a name="ienumdebugprocesses2getcount"></a>IEnumDebugProcesses2::GetCount
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [IEnumDebugProcesses2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprocesses2-getcount).  
