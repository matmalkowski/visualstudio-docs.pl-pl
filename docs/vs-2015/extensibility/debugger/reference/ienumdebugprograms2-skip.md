...
ms.locfileid: "42681358"
---
# <a name="ienumdebugprograms2skip"></a>IEnumDebugPrograms2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [IEnumDebugPrograms2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprograms2-skip).  
