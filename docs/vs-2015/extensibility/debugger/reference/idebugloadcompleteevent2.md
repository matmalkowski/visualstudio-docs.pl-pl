...
ms.locfileid: "42628884"
---
# <a name="idebugloadcompleteevent2"></a>IDebugLoadCompleteEvent2
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [IDebugLoadCompleteEvent2](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugloadcompleteevent2).  
