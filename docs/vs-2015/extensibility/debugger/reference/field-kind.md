...
ms.locfileid: "42671442"
---
# <a name="fieldkind"></a>FIELD_KIND
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [FIELD_KIND](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/field-kind).  
