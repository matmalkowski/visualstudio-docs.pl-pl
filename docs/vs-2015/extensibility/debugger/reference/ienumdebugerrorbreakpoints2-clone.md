...
Najnowszą wersję tego tematu znajduje się w temacie [IEnumDebugErrorBreakpoints2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugerrorbreakpoints2-clone).  
