...
Najnowszą wersję tego tematu znajduje się w temacie [NATIVE_ADDRESS](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/native-address).  
