...
ms.locfileid: "42683475"
---
# <a name="ienumdebugcodecontexts2skip"></a>IEnumDebugCodeContexts2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [IEnumDebugCodeContexts2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugcodecontexts2-skip).  
