...
ms.locfileid: "42676820"
---
# <a name="portsupplierdescriptionflags"></a>PORT_SUPPLIER_DESCRIPTION_FLAGS
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [PORT_SUPPLIER_DESCRIPTION_FLAGS](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/port-supplier-description-flags).  
