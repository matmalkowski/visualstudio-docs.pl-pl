...
Najnowszą wersję tego tematu znajduje się w temacie [IDebugGenericParamField::GetOwner](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebuggenericparamfield-getowner).  
