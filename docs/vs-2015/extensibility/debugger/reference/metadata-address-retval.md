...
Najnowszą wersję tego tematu znajduje się w temacie [METADATA_ADDRESS_RETVAL](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/metadata-address-retval).  
