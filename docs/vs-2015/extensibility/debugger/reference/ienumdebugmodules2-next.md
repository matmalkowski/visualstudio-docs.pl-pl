...
ms.locfileid: "42682531"
---
# <a name="ienumdebugmodules2next"></a>IEnumDebugModules2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [IEnumDebugModules2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugmodules2-next).  
