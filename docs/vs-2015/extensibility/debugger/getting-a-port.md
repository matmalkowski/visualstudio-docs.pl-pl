...
ms.locfileid: "42677671"
---
# <a name="getting-a-port"></a>Pobieranie portu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [pobieranie portu](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-a-port).  
