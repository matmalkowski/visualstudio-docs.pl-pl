...
ms.locfileid: "42685898"
---
# <a name="sample-implementation-of-changing-values"></a>Przykład implementacji zmieniania wartości
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [zmiana wartości przykładowych implementacji](https://docs.microsoft.com/visualstudio/extensibility/debugger/sample-implementation-of-changing-values).  
