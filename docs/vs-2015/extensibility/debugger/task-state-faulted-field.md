...
ms.locfileid: "42684795"
---
# <a name="taskstatefaulted-field"></a>TASK_STATE_FAULTED, pole
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [pole TASK_STATE_FAULTED](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-faulted-field).  
