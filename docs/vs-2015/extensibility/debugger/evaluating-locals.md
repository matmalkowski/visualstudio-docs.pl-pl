...
ms.locfileid: "42696743"
---
# <a name="evaluating-locals"></a>Ocenianie zmiennych lokalnych
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [ocenianie zmiennych lokalnych](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
