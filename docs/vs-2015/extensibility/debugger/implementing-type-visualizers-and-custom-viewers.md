...
Najnowszą wersję tego tematu znajduje się w temacie [Implementowanie Wizualizatorów typu i przeglądarek niestandardowych](https://docs.microsoft.com/visualstudio/extensibility/debugger/implementing-type-visualizers-and-custom-viewers).  
