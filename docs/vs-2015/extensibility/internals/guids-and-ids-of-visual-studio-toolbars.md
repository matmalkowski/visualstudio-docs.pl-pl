...
Najnowszą wersję tego tematu znajduje się w temacie [identyfikatory GUID i identyfikatory programu Visual Studio pasków narzędzi](https://docs.microsoft.com/visualstudio/extensibility/internals/guids-and-ids-of-visual-studio-toolbars).  
