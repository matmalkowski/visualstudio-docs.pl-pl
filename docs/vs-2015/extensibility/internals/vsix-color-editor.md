...
ms.locfileid: "42679597"
---
# <a name="vsix-color-editor"></a>Edytor kolorów VSIX
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Edytor kolorów VSIX](https://docs.microsoft.com/visualstudio/extensibility/internals/vsix-color-editor).  
