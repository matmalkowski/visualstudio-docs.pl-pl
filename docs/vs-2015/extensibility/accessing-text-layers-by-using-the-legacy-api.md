...
Najnowszą wersję tego tematu znajduje się w temacie [uzyskiwania dostępu do warstwy tekstu za pomocą starszej wersji interfejsu API](https://docs.microsoft.com/visualstudio/extensibility/accessing-text-layers-by-using-the-legacy-api).  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Dostosowywanie menu i formantów w edytorze za pomocą starszej wersji interfejsu API](../extensibility/customizing-editor-controls-and-menus-by-using-the-legacy-api.md)
