...
ms.locfileid: "42630144"
---
# <a name="language-service-and-editor-extension-points"></a>Punkty rozszerzeń usługi językowej i edytora
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [usługi językowej i edytora punkty rozszerzenia](https://docs.microsoft.com/visualstudio/extensibility/language-service-and-editor-extension-points).  
