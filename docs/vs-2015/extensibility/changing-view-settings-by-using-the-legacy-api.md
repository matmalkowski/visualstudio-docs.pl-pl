...
Najnowszą wersję tego tematu znajduje się w temacie [Zmienianie ustawień widoku przy użyciu interfejsu API starszych](https://docs.microsoft.com/visualstudio/extensibility/changing-view-settings-by-using-the-legacy-api).  
