...
ms.locfileid: "42630586"
---
# <a name="commandplacements-element"></a>CommandPlacements, element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [CommandPlacements, Element](https://docs.microsoft.com/visualstudio/extensibility/commandplacements-element).  
