...
ms.locfileid: "42677036"
---
# <a name="ide-guids"></a>Identyfikatory GUID środowiska IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [identyfikatory GUID środowiska IDE](https://docs.microsoft.com/visualstudio/extensibility/ide-guids).  
