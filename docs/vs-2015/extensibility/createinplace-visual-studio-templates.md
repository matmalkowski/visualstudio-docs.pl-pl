...
ms.locfileid: "42688708"
---
# <a name="createinplace-visual-studio-templates"></a>CreateInPlace (szablony Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [CreateInPlace (szablony Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/createinplace-visual-studio-templates).  
