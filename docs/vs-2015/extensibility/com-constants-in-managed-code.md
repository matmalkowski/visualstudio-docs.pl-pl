...
ms.locfileid: "42681120"
---
# <a name="com-constants-in-managed-code"></a>Stałe modelu COM w kodzie zarządzanym
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [stałe modelu COM w kodzie zarządzany](https://docs.microsoft.com/visualstudio/extensibility/com-constants-in-managed-code).  
