...
ms.locfileid: "42683952"
---
# <a name="sccdirqueryinfo-function"></a>SccDirQueryInfo, funkcja
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [funkcja SccDirQueryInfo](https://docs.microsoft.com/visualstudio/extensibility/sccdirqueryinfo-function).  
