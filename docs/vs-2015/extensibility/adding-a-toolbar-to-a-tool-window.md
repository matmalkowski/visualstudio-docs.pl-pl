...
ms.locfileid: "42678373"
---
# <a name="adding-a-toolbar-to-a-tool-window"></a>Dodawanie paska narzędzi do okna narzędzi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Dodawanie paska narzędzi do okna narzędzi](https://docs.microsoft.com/visualstudio/extensibility/adding-a-toolbar-to-a-tool-window).  
