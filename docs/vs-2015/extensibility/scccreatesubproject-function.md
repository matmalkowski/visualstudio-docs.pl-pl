...
ms.locfileid: "42678567"
---
# <a name="scccreatesubproject-function"></a>SccCreateSubProject, funkcja
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [funkcja SccCreateSubProject](https://docs.microsoft.com/visualstudio/extensibility/scccreatesubproject-function).  
