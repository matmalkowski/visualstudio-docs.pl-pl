...
Najnowszą wersję tego tematu znajduje się w temacie [najlepsze rozwiązania dotyczące wdrażania wtyczki kontroli źródła](https://docs.microsoft.com/visualstudio/extensibility/best-practices-for-implementing-a-source-control-plug-in).  
