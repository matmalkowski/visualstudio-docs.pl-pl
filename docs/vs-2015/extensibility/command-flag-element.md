...
ms.locfileid: "42681790"
---
# <a name="command-flag-element"></a>Command Flag, element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [Command Flag, Element](https://docs.microsoft.com/visualstudio/extensibility/command-flag-element).  
