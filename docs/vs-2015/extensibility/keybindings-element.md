...
ms.locfileid: "42681593"
---
# <a name="keybindings-element"></a>KeyBindings, element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [KeyBindings, Element](https://docs.microsoft.com/visualstudio/extensibility/keybindings-element).  
