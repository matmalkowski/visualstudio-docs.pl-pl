...
ms.locfileid: "42678066"
---
# <a name="target-build-order"></a>Kolejność kompilowania obiektów docelowych
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [kolejności kompilacji docelowej](https://docs.microsoft.com/visualstudio/msbuild/target-build-order).  
