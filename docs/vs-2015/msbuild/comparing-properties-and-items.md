...
ms.locfileid: "42675819"
---
# <a name="comparing-properties-and-items"></a>Porównanie właściwości i elementów
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [porównanie właściwości i elementy](https://docs.microsoft.com/visualstudio/msbuild/comparing-properties-and-items).  
