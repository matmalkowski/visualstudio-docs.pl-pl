...
ms.locfileid: "42633065"
---
# <a name="combinepath-task"></a>CombinePath — Zadanie
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [combinepath — zadanie](https://docs.microsoft.com/visualstudio/msbuild/combinepath-task).  
