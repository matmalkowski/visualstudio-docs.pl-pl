...
Najnowszą wersję tego tematu znajduje się w temacie [dodatkowe zasoby MSBuild](https://docs.microsoft.com/visualstudio/msbuild/additional-msbuild-resources).  
