...
ms.locfileid: "42681921"
---
# <a name="msbuild-items"></a>Elementy programu MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [elementy programu MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-items).  
