...
ms.locfileid: "42676454"
---
# <a name="createcsharpmanifestresourcename-task"></a>CreateCSharpManifestResourceName — Zadanie
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [createcsharpmanifestresourcename — zadanie](https://docs.microsoft.com/visualstudio/msbuild/createcsharpmanifestresourcename-task).  
