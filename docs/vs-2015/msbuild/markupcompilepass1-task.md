...
ms.locfileid: "42629090"
---
# <a name="markupcompilepass1-task"></a>MarkupCompilePass1 — Zadanie
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [markupcompilepass1 — zadanie](https://docs.microsoft.com/visualstudio/msbuild/markupcompilepass1-task).  
