...
ms.locfileid: "42628389"
---
# <a name="resolving-assemblies-at-design-time"></a>Rozwiązywanie zestawów w czasie projektowania
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [rozwiązywanie zestawów w czasie projektowania](https://docs.microsoft.com/visualstudio/msbuild/resolving-assemblies-at-design-time).  
