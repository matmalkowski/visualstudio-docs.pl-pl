...
ms.locfileid: "42692442"
---
# <a name="walkthrough-using-msbuild"></a>Wskazówki: używanie programu MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [wskazówki: Korzystanie z programu MSBuild](https://docs.microsoft.com/visualstudio/msbuild/walkthrough-using-msbuild).  
