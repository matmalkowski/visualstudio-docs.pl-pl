...
ms.locfileid: "42677192"
---
# <a name="itemgroup-element-msbuild"></a>ItemGroup — Element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [itemgroup — Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/itemgroup-element-msbuild).  
