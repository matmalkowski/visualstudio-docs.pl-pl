...
ms.locfileid: "42685507"
---
# <a name="sample-xsd-file-purchase-order-schema"></a>Przykładowy plik XSD: Schemat zamówienia zakupu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Najnowszą wersję tego tematu znajduje się w temacie [przykładowy plik XSD: schemat zamówienia zakupu](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-purchase-order-schema).  
