...
|<xref:System.Activities.Statements.Interop.ActivityType%2A>|Wartość true|Określa typ działania zawarty w <xref:System.Activities.Statements.Interop> działania. Ten określony typ musi pochodzić od <xref:System.Workflow.ComponentModel.Activity>.|  
