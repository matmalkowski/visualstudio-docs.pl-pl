---
title: "Porady: należy użyć funkcji wyszukiwania w Projektancie przepływów pracy | Dokumentacja firmy Microsoft"
ms.date: 11/04/2016
ms.topic: reference
...
## <a name="quick-find"></a>Szybkie wyszukiwanie  
 Szybkie szukanie znajdziesz następujące w Projektancie:  
...
3.  Wyniki wyszukiwania będą wyświetlane w [!INCLUDE[vs_current_short](../code-quality/includes/vs_current_short_md.md)] **Znajdź wynik** widoku. Dwukrotne kliknięcie elementu wynik przejdzie do działania, która zawiera dopasowania w Projektancie przepływów pracy.