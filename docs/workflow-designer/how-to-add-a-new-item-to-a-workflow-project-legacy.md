...
|Element|Opis|
|----------|-----------------|
|Działanie|Działanie z definicją działania w kodu projektanta pliku i kodem użytkownika w osobnym pliku kodu.|
|Działania (z separacją kodu)|Definicja działania wyrażonej w postaci przepływu pracy znaczników i kodem użytkownika w osobnym pliku kodu.|
|Sekwencyjny przepływ pracy (kod)|Sekwencyjny przepływ pracy z definicją przepływu pracy w kodu projektanta pliku i kodem użytkownika w osobnym pliku kodu.|
