...
Rozwija reguły wskazówek dotyczących projektowania Microsoft rozszerzony zestaw reguł na reguły wskazówek dotyczących projektowania podstawowych, aby zmaksymalizować zgłaszanych problemów użytecznością i utrzymaniem. Dodatkowy nacisk jest kładziony na wskazówki dotyczące nazewnictwa. Należy rozważyć dołączenie tego zestawu, jeśli projekt zawiera kod biblioteki lub jeśli chcesz wymuszenia najwyższych standardów dotyczące pisania kodu, który jest łatwe w konserwacji reguł.
 ...
 Rozszerzone reguły wskazówek dotyczących projektowania obejmują wszystkie podstawowe reguły wskazówek dotyczących projektowania firmy Microsoft. Podstawowe reguły wskazówek dotyczących projektowania obejmują wszystkie reguły Zalecana minimalna firmy Microsoft. Aby uzyskać więcej informacji, zobacz [zestaw reguł podstawowe reguły wskazówek dotyczących projektowania dla zarządzanego kodu](../code-quality/basic-design-guideline-rules-rule-set-for-managed-code.md) i [ustawić zarządzane zalecane reguły dla zarządzanego kodu](../code-quality/managed-recommended-rules-rule-set-for-managed-code.md)
...
|[CA1021](../code-quality/ca1021-avoid-out-parameters.md)|Unikanie parametrów wyjściowych|
...
|[CA1505](../code-quality/ca1505-avoid-unmaintainable-code.md)|Unikaj kodu|
|[CA1506](../code-quality/ca1506-avoid-excessive-class-coupling.md)|Unikaj nadmiernego sprzężenia klas|
|[CA1700](../code-quality/ca1700-do-not-name-enum-values-reserved.md)|Nie nadawać wartościom enum oznaczenia "Reserved"|
...
|[CA1702](../code-quality/ca1702-compound-words-should-be-cased-correctly.md)|Wyrazy złożone powinien mieć prawidłową wielkość liter|
|[CA1703](../code-quality/ca1703-resource-strings-should-be-spelled-correctly.md)|Ciągi zasobów, które powinny być napisane poprawnie|
|[CA1704](../code-quality/ca1704-identifiers-should-be-spelled-correctly.md)|Identyfikatory powinny być napisane poprawnie|
...
|[CA1710](../code-quality/ca1710-identifiers-should-have-correct-suffix.md)|Identyfikatory powinny mieć poprawny przyrostek|
...
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|Nie dodawaj prefiksu wartości enum nazwą typu|
|[CA1713](../code-quality/ca1713-events-should-not-have-before-or-after-prefix.md)|Zdarzenia nie powinny posiadać prefiksów before ani after|
|[CA1714](../code-quality/ca1714-flags-enums-should-have-plural-names.md)|Wyliczeniowe flag powinny mieć nazwy w liczbie mnogiej|
...
|[CA1725](../code-quality/ca1725-parameter-names-should-match-base-declaration.md)|Nazwy parametrów powinny pasować do podstawowej deklaracji|
