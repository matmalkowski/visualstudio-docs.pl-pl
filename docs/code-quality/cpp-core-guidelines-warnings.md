...
## <a name="attributes"></a>Atrybuty
 Kompilator Microsoft Visual C++ ma ograniczoną obsługę GSL Pomiń atrybut.
Może służyć do Pomijaj ostrzeżenia w przypadku wyrażeń i instrukcji bloku wewnątrz funkcji.
