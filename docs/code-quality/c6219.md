...
Ostrzeżenie C6219: niejawne rzutowanie pomiędzy różnymi semantycznie typami: porównanie HRESULT z 1 lub TRUE. Należy rozważyć użycie [zakończyło się pomyślnie](http://go.microsoft.com/fwlink/?LinkId=92738) lub [FAILED](ms-help://MS.VSCC.2003/MS.MSDNQTR.2003FEB.1033/com/htm/error_899v.htm) makro zamiast niego  
