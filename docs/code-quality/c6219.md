...
ms.locfileid: "31891724"
---
# <a name="c6219"></a>C6219
Ostrzeżenie C6219: niejawne rzutowanie pomiędzy różnymi semantycznie typami: porównanie HRESULT z 1 lub TRUE. Rozważ użycie makra [SUCCEEDED](http://go.microsoft.com/fwlink/?LinkId=92738) lub [FAILED](ms-help://MS.VSCC.2003/MS.MSDNQTR.2003FEB.1033/com/htm/error_899v.htm).
