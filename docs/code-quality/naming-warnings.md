...
|[CA1724: Nazwy typów nie powinny pasować do przestrzeni nazw](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|Nazwy typów nie powinny odpowiadać nazwy przestrzeni nazw, które są zdefiniowane w bibliotece klas programu .NET Framework. Naruszenie tej zasady może zmniejszyć użyteczność biblioteki.|
