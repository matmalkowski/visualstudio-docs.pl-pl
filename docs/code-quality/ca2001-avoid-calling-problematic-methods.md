...
Unikaj niepotrzebnych i potencjalnie niebezpiecznych wywołań. Naruszenie tej reguły występuje, gdy element członkowski wywołuje jeden z następujących metod:
