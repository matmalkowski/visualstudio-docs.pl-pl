---
title: "CA5351 Nie używaj przerwane algorytmów kryptograficznych | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   MD5, użyj wartości skrótów w [SHA-2](https://msdn.microsoft.com/en-us/library/windows/desktop/aa382459.aspx) rodziny (np. <xref:System.Security.Cryptography.SHA512>, <xref:System.Security.Cryptography.SHA384>, <xref:System.Security.Cryptography.SHA256>).  
