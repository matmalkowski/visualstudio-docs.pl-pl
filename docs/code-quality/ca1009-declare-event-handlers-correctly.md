...
## <a name="see-also"></a>Zobacz też
 <xref:System.EventArgs?displayProperty=fullName> <xref:System.Object?displayProperty=fullName> [Obsługa i wywoływanie zdarzeń](/dotnet/standard/events/index)