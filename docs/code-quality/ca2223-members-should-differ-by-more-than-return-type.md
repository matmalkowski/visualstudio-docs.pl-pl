...
---
# <a name="ca2223-members-should-differ-by-more-than-return-type"></a>CA2223: Elementy członkowskie powinny różnić się bardziej, niż typem zwracanym
|||  
|-|-|  
...
## <a name="example"></a>Przykład  
 Poniższy przykład w języku pośrednim firmy Microsoft (MSIL) zawiera typ, który narusza tę regułę. Należy zauważyć, że ta zasada nie można oznaczać naruszenie przy użyciu języka C# lub Visual Basic .NET.  
