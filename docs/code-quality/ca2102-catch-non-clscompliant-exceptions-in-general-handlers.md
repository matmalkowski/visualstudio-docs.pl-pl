...
## <a name="see-also"></a>Zobacz też
 [Wyjątki i obsługa wyjątków](/dotnet/csharp/programming-guide/exceptions/exceptions-and-exception-handling) [Ilasm.exe (asembler IL)](/dotnet/framework/tools/ilasm-exe-il-assembler) [niezależność od języka i elementy niezależne od języka](/dotnet/standard/language-independence-and-language-independent-components)