...
Ostrzeżenie C26165: prawdopodobnie nie udało się zwolnić blokady \<blokady > w funkcji \<func >.  
  
 Ostrzeżenie C26165 podobny ostrzeżenie [C26115](../code-quality/c26115.md) z tą różnicą, że poziom ufności jest niższa. Na przykład funkcja może zawierać błędy adnotacji.  
...
## <a name="example"></a>Przykład  
 Aby usunąć to ostrzeżenie, zmień poprzedniego przykładu do następującego.  
