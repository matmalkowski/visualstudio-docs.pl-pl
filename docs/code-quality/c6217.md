...
Ostrzeżenie C6217: niejawne rzutowanie pomiędzy różnymi semantycznie typami: testowanie HRESULT za pomocą "not". Zamiast tego użyj makro [SUCCEEDED](http://go.microsoft.com/fwlink/?LinkId=92738) lub [FAILED](ms-help://MS.VSCC.2003/MS.MSDNQTR.2003FEB.1033/com/htm/error_899v.htm).  
