---
title: Przy użyciu programy wytyczne Core C++
ms.date: 11/04/2016
ms.topic: conceptual
author: mikeblome
ms.author: mblome
...
Jak nowe zasady zostaną dodane do sprawdzania wytyczne Core C++, może zwiększyć liczbę ostrzeżeń, które są tworzone dla istniejącego kodu. Zestawy wstępnie zdefiniowanych reguł służy do filtrowania rodzajów reguły, aby włączyć.
