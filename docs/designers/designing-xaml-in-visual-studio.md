...
Proces projektowania aplikacji zależy od wybranego narzędzia i platformy docelowej. Ten artykuł zawiera porównanie narzędzi projektowania XAML w Visual Studio i Blend for Visual Studio. Aby uzyskać bardziej szczegółowe wskazówki dotyczące korzystania z narzędzi zobacz następujące tematy:
...
## <a name="choose-the-right-tool"></a>Wybierz właściwych narzędzi
