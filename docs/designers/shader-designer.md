...
## <a name="working-with-the-shader-designer"></a>Praca z programem Designer programu do cieniowania  
...
###### <a name="to-choose-a-preview-shape"></a>Wybierz kształt podglądu  
...
###### <a name="to-enable-real-time-rendering"></a>Aby umożliwić renderowanie w czasie rzeczywistym  
  
-   Na pasku narzędzi programu do cieniowania Designer wybierz **renderowania w czasie rzeczywistym**.  
...
###### <a name="to-rotate-the-shape"></a>Obracanie kształtu  
  
-   Naciśnij i przytrzymaj klawisz Alt, a następnie wybierz dowolnego punktu na powierzchni projektu i przenieść go.  
