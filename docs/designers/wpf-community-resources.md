...
## <a name="community"></a>Społeczność  
 ...
 [Przepełnienie stosu](http://stackoverflow.com/questions/tagged/wpf)  
  
 [Blog zespołu programu WPF](http://blogs.msdn.com/b/wpf/)  
  
 [Zestawu narzędzi WPF w witrynie CodePlex](http://wpf.codeplex.com/)  
  
 [Centrum deweloperów systemu Windows Presentation Foundation](https://www.visualstudio.com/features/wpf-vs)  
  
## <a name="provide-feedback"></a>Przekazywanie opinii  
 Podaj swoją opinię na temat WPF na [Microsoft Connect](https://connect.microsoft.com/VisualStudio/Feedback).  
