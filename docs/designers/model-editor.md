...
|Tytuł|Opis|  
|-----------|-----------------|  
|[Praca z obiektami 3-D do gier i aplikacji](../designers/working-with-3-d-assets-for-games-and-apps.md)|Zawiera omówienie [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia służące do pracy z zasobów graficznych, takich jak tekstury i obrazów, 3-modele i efekty programu do cieniowania.|  
