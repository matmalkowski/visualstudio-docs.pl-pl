...
|[Korzystanie z zasobów 3D w aplikacji lub gry](../designers/using-3-d-assets-in-your-game-or-app.md)|W tym artykule opisano, jak używasz [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] przetworzyć 3D zasoby podczas konstruowania projekcie lub rozwiązaniu, tak aby były gotowe do użycia w aplikacji. Omówiono także strategii ładowania różnych rodzajów zasobów w aplikacji.|
