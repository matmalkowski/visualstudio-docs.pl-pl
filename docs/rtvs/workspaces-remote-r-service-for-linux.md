...
Usługa zdalnego R dla systemu Linux jest obecnie dostarczana w rtvs demon. Demon jest obsługiwana i przetestowany Ubuntu 16.04, 16.10 pulpitu LTS, serwera i podsystem Windows systemem Ubuntu Linux. Zbiorczego w tym temacie zawiera instrukcje dotyczące konfigurowania usługi zdalnej R na tych systemów.
