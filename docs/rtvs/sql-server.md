---
title: "Integrowanie programu SQL Server z R narzędzi dla programu Visual Studio | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 06/30/2017
ms.reviewer: 
ms.suite: 
...
Możesz teraz interaktywnie zapisu R obsługujące `InputDataSet` dataframe zgodnie z potrzebami. Należy pamiętać, że można po prostu wybierz R kodu w edytorze i wysyłać je do [okna interaktywnego](interactive-repl.md) przez naciśnięcie klawiszy Ctrl + Enter.
