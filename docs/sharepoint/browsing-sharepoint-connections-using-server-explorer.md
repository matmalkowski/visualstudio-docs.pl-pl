...
## <a name="node-shortcut-menu-commands"></a>Polecenia menu skrótów węzła
 Każdy węzeł ma menu skrótów, do którego dostęp przez kliknięcie prawym przyciskiem myszy węzeł lub wybierając go, a następnie wybierając **Shift**+**F10** kluczy. Węzeł poleceń mogą obejmować:  
