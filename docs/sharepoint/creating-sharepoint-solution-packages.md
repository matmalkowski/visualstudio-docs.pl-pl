...
|Resetuj serwer sieci Web|Opcjonalna. Wybierz, aby ponownie uruchomić serwer sieci Web po plik wsp jest zainstalowany na serwerze programu SharePoint.|  
