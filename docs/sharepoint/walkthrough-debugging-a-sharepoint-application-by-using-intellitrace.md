...
# <a name="walkthrough-debugging-a-sharepoint-application-by-using-intellitrace"></a>Wskazówki: debugowanie aplikacji SharePoint przy użyciu narzędzia IntelliTrace
 ...
 W tym przewodniku pokazano, jak do debugowania za pomocą programu Microsoft Monitoring Agent zbierania danych funkcji IntelliTrace z wdrożonych aplikacji SharePoint 2010 lub SharePoint 2013 projektu w programie Visual Studio Ultimate. Aby analizować te dane, należy użyć programu Visual Studio Ultimate. Ten projekt zawiera Odbiorca funkcji, które po aktywowaniu funkcji dodaje zadania do listy zadań i powiadomienia na liście anonsów. Gdy funkcja jest dezaktywowana, zadanie zostanie oznaczone jako wykonane, a drugi anonsu zostanie dodany do listy anonsów. Jednak procedura zawiera logiczny błąd, który uniemożliwia uruchomiony prawidłowo projektu. Przy użyciu funkcji IntelliTrace, należy znaleźć i popraw błąd.  
...
#### <a name="to-create-a-feature-receiver"></a>Aby utworzyć odbiorcę funkcji  
...
#### <a name="to-add-code-to-the-feature-receiver"></a>Aby dodać kod do odbiorcy funkcji  
...
#### <a name="to-debug-and-fix-the-sharepoint-solution"></a>Aby debugować i naprawić rozwiązanie SharePoint  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Wskazówki: Sprawdź kod programu SharePoint przy użyciu testów jednostkowych](https://msdn.microsoft.com/en-us/library/gg599006(v=vs.100).aspx)  
