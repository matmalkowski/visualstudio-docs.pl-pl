...
2.  Dodaj jeden lub więcej funkcji programu SharePoint, wykonując jedną lub więcej z następujących czynności:  
    ...
    2.  Wybierz element, który chcesz dodać, a następnie wybierz pozycję **Dodaj** przycisk (>).  
  
    3.  Wybierz **Dodaj wszystkie** przycisk (>>) aby dodać wszystkie elementy jednocześnie.  
  
     Można na przykład kliknij dwukrotnie element **elementów w rozwiązaniu** listy, aby dodać go do **elementów w pakiecie** listy.  
  
     SharePoint — elementy projektu i funkcje są wyświetlane w **elementów w pakiecie** listy.  
