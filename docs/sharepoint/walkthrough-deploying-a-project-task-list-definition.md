...
-   [Tworzenie listy programu SharePoint](#CreatingListDef).  
  
-   [Tworzenie listy programu SharePoint](#CreatingListDef).  
  
-   [Dodawanie odbiorca zdarzenia](#AddEventRcvr).  
  
-   [Dostosowywanie funkcji listy zadań projektu](#CustomizeFeature).  
  
-   [Lista zadań tworzenia i testowania projektu](#BuildTest).  
...
#### <a name="to-create-a-sharepoint-list-project"></a>Aby utworzyć projekt listy programu SharePoint  
...
#### <a name="to-add-an-event-receiver"></a>Aby dodać odbiorcy zdarzeń  
...
#### <a name="to-customize-the-project-task-list-feature"></a>Aby dostosować funkcji listy zadań projektu  
...
#### <a name="to-customize-the-project-task-list-package"></a>Aby dostosować pakiet listy zadań projektu  
...
#### <a name="to-test-the-project-task-list"></a>Aby przetestować listy zadań projektu  
...
1.  Na pasku menu programu Visual Studio wybierz **kompilacji**, **wdrożyć rozwiązanie**.  
