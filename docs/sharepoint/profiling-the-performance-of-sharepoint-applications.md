...
## <a name="profile-tools-overview"></a>Omówienie narzędzia profil
...
## <a name="stress-test"></a>Test obciążenia
...
## <a name="test-user-interfaces"></a>Interfejsy użytkownika testowego
