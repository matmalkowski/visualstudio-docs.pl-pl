...
## <a name="creating-a-sharepoint-deployment-configuration"></a>Tworzenie konfiguracji wdrażania SharePoint  
...
## <a name="changing-the-active-deployment-configuration"></a>Zmienianie konfiguracji aktywnych wdrożeń  
