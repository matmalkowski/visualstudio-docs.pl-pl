---
title: "Propaguj zmiany poza modelu do obsługi zdarzeń | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="using-events-to-make-undoable-adjustments-in-the-store"></a>Wprowadź można cofnąć zmiany w magazynie przy użyciu zdarzeń  
