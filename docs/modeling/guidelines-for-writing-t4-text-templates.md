---
title: Wskazówki dotyczące pisania szablonów tekstowych T4 | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.reviewer: ''
ms.suite: ''
...
-   Klasy powinny być generowane w parach, jeden dziedziczenie z innych. Klasa podstawowa powinna zawierać wszystkie wygenerowane metody i właściwości, a klasa pochodna powinna zawierać tylko konstruktory. Dzięki temu odręcznego do przesłonięcia żadnej z metod wygenerowanego kodu.  
 ...
 Przenieś wspólnej materiałów do plików dołączanych lub szablony w czasie wykonywania  
 Aby uniknąć powtarzania podobne bloki tekstu i kodu w różnych szablonach, użyj `<#@ include #>` dyrektywy. Aby uzyskać więcej informacji, zobacz [obejmują dyrektywa T4 dotycząca](../modeling/t4-include-directive.md).  
...
## <a name="guidelines-for-run-time-preprocessed-t4-templates"></a>Wytyczne dotyczące szablony T4 (wstępnie przetworzonych) środowiska wykonawczego  
 Przenieś wspólnej materiałów do dziedziczonej szablonów  
 Dziedziczenie umożliwia udostępnianie metod i bloki tekstu między szablonów tekstowych T4. Aby uzyskać więcej informacji, zobacz [dyrektywa T4 dotycząca szablonu](../modeling/t4-template-directive.md).  
 ...
 Należy wziąć pod uwagę generowania metody wirtualne w \<#+ klasy funkcja blokuje #>. Dzięki temu jednego szablonu używanego w kontekstach wiele bez żadnych modyfikacji. Modyfikowanie szablonu, a nie można utworzyć klasy pochodnej, która dostarcza minimalna dodatkową logikę. Klasa pochodna może być albo regularne kodu lub może być szablonem czasu wykonywania.  
