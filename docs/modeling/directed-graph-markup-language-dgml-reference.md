---
title: "Przekierowanie Graph Markup Language) dokumentacja języka (DGML | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   `<Node/>`  
     ...
     Atrybuty stylu. Zobacz [mapy Dostosuj kodu przez edycję plików DGML](../modeling/customize-code-maps-by-editing-the-dgml-files.md).  
...
-   `<Category/>`  
     ...
     Kategorie zapewniają również zachowanie niektóre podstawowe szablonu steruje wyglądem węzły i łącza, gdy zostaną one wyświetlone na mapie. Zobacz [mapy Dostosuj kodu przez edycję plików DGML](../modeling/customize-code-maps-by-editing-the-dgml-files.md).  
