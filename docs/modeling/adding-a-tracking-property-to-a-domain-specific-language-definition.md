...
## <a name="customizing-the-default-dsl-definition"></a>Dostosowywanie definicji domyślnej DSL  
...
#### <a name="to-transform-the-text-templates"></a>Do transformacji szablonów tekstowych  
...
## <a name="adding-helper-classes-to-support-tracking-properties"></a>Dodawanie klas pomocnika do obsługi śledzenia właściwości  
...
#### <a name="to-add-the-helper-classes"></a>Aby dodać klasy pomocy  
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Aby zaktualizować pakiet DSL do użycia z deskryptora typu niestandardowego  
...
## <a name="testing-the-language"></a>Testowanie język  
...
#### <a name="to-exercise-the-language"></a>Do korzystania z języka  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Porady: tworzenie rozwiązania języka specyficznego dla domeny](../modeling/how-to-create-a-domain-specific-language-solution.md)   
