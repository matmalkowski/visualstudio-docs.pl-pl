---
title: Sprawdzanie poprawności danych w zestawach danych
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
- [Instrukcje: sprawdzanie poprawności danych w kontrolce DataGridView formularzy Windows Forms](/dotnet/framework/winforms/controls/how-to-validate-data-in-the-windows-forms-datagridview-control)
