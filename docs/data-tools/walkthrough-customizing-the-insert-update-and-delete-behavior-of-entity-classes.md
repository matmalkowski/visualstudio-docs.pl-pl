...
-   Tworzenie nowej aplikacji formularzy systemu Windows i Dodaj LINQ do SQL pliku do niego.
...
-   Utwórz <xref:System.Data.Linq.DataContext> metod przez dodanie przechowywane procedury do Projektanta obiektów relacyjnych.
...
Ponieważ użytkownik zostanie praca z LINQ w klasach SQL i wyświetlanie danych w formularzu systemu Windows, tworzenie nowej aplikacji formularzy systemu Windows i Dodaj LINQ do SQL klasy pliku.
...
6.  Kliknij przycisk **Dodaj**.
     ...
     Pusty LINQ w klasach SQL pliku (Northwind.dbml) zostanie dodany do projektu, a następnie otwiera Projektanta obiektów relacyjnych.
...
Utwórz LINQ w klasach SQL, które są mapowane w tabelach bazy danych przez przeciągnięcie tabel z **Eksploratora serwera**/**Eksploratora bazy danych** do Projektanta obiektów relacyjnych. Wynik jest LINQ w klasach SQL jednostki, które mapują do tabel w bazie danych. Po utworzeniu klas jednostek one może służyć jako obiekt źródła danych, podobnie jak inne klasy, których właściwości publicznej.
...
2.  Przeciągnij **klientów** węzła z **Eksploratora serwera**/**Eksploratora bazy danych** na powierzchnię Projektanta obiektów relacyjnych.
...
Tworzenie formantów, które są powiązane z klasami jednostki przeciągając LINQ do SQL elementów źródła danych z **źródeł danych** okna na formularzu systemu Windows.
...
1.  Otwórz LINQ do SQL pliku w Projektancie obiektów relacyjnych. (Kliknij dwukrotnie **Northwind.dbml** w pliku **Eksploratora rozwiązań**.)
...
3.  Przeciągnij wszystkich trzech procedur składowanych do Projektanta obiektów relacyjnych.
...
4.  Wybierz **klienta** klasy jednostki w Projektancie obiektów relacyjnych.
...
10. Naciśnij klawisz **F5** i upewnij się, że usunięty rekord został usunięty z bazy danych.
...
W zależności od wymagań aplikacji istnieje kilka kroków, które można wykonać po utworzeniu LINQ do SQL klas jednostek. Oto niektóre ulepszenia, jakie można wprowadzać tej aplikacji:
