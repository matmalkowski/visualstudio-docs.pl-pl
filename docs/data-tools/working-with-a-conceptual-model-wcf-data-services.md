---
title: "Praca z modelu koncepcyjnego (usługi danych WCF) | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Korzystając z modelu koncepcyjnego do opisu danych w bazie danych, można badać danych za pośrednictwem obiektów zamiast do i z powrotem tłumaczenia schematu bazy danych i modelu obiektu.  
 ...
 Modele koncepcyjne można użyć z aplikacjami usługi danych WCF. W następujących tematach opisano, jak wykonać zapytanie dotyczące danych za pośrednictwem modelu koncepcyjnego.  
...
|[Instrukcje: Projekt wyników zapytania](/dotnet/framework/data/wcf/how-to-project-query-results-wcf-data-services)|Pokazuje, jak można zmniejszyć ilość danych zwróconych przez zapytanie usługi danych.|  
 ...
 W następujących tematach opisano sposób dodawania sprawdzania poprawności do aplikacji usługi danych WCF.  
