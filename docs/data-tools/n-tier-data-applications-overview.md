---
title: "Omówienie aplikacji warstwowych | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
![Środkowy składników warstwy](../data-tools/media/ntiermid.png "NtierMid")  
Warstwa środkowa  
...
![Składniki warstwy danych](../data-tools/media/ntierdatatier.png "ntierdatatier")  
Warstwa danych  
