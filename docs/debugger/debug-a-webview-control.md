...
![Ma zastosowanie do systemu Windows i Windows Phone](../debugger/media/windows_and_phone_content.png "windows_and_phone_content")  
 ...
 Do przeglądania i debugowania `WebView` formantów w aplikacji środowiska wykonawczego systemu Windows, można skonfigurować programu Visual Studio można dołączyć debugera skryptów po uruchomieniu aplikacji. Począwszy od programu Visual Studio 2013 Update 2, ma dwa sposoby interakcji z `WebView` steruje korzystanie z debugera:  
