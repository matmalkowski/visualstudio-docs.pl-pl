...
|         |         |
|---------|---------|
| ![Obejrzyj film](../install/media/video-icon.png "WatchVideo") | [Obejrzyj film](#video) na debugowanie wielowątkowe, który zawiera podobne kroki. |
...
## <a name="video"></a>Obejrzyj film na debugowanie wielowątkowe
