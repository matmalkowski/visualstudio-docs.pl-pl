 ...
 **Ogólne** karta jest karcie tylko wyświetlić. W systemach operacyjnych Windows 98 i system operacyjny Windows 95 zmodyfikowanej wersji na tej karcie jest wyświetlana.  
  
## <a name="in-this-section"></a>W tej sekcji  
 [Karta ogólna, okno dialogowe właściwości wątku](../debugger/general-tab-thread-properties-dialog-box.md)  
 Aby dowiedzieć się więcej na temat wybranego wątku, użyj tego okna dialogowego.  
