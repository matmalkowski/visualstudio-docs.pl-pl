...
#### <a name="parameters"></a>Parametry  
 `pRetVal`  
 [out] Zwraca `TRUE` Jeśli kompilator, generowany symbol; w przeciwnym razie zwraca `FALSE` , jeśli symbol został wygenerowany na podstawie źródła zapisane przez użytkownika.  
