...
#### [Błąd: Monitor zdalnego debugowania programu Microsoft Visual Studio na komputerze zdalnym nie ma uprawnień do połączenia z tym komputerem](error-the-microsoft-visual-studio-remote-debugging-monitor-no-permission.md)
...
#### [Ostrzeżenie o zabezpieczeniach: Dołączanie do procesu należącego do niezaufanego użytkownika może być niebezpieczne. Jeśli informacje wyglądają podejrzanie lub nie masz do nich pełnego zaufania, nie dołączaj do tego procesu](security-warning-attaching-to-a-process-owned-by-an-untrusted-user.md)
