...
|Dodatków VSTO|Excel<br /><br /> InfoPath (InfoPath 2013 i InfoPath 2010)<br /><br /> Outlook<br /><br /> PowerPoint<br /><br /> Project<br /><br /> Visio<br /><br /> Word<br /><br /> Excel|  
...
|Niestandardowe elementy XML.|Projektów na poziomie dokumentu.<br /><br /> Projekty poziomu aplikacji dla następujących aplikacji:<br /><br /> -Programu Excel<br />-Programu PowerPoint<br />-Word|[Przegląd części niestandardowy plik XML](../vsto/custom-xml-parts-overview.md)|  
