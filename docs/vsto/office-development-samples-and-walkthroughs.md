...
# <a name="office-development-samples-and-walkthroughs"></a>Office Development ― Przykłady i wskazówki
 ...
 Przykładowy kod jest przeznaczony dla celów informacyjny i nie powinna być używana w rozwiązaniach wdrożonej bez modyfikacji. W szczególności zabezpieczeń musi być brana pod uwagę większa.  
  
 Aby uzyskać informacje na temat zabezpieczania aplikacji, zobacz [Zabezpieczanie rozwiązań pakietu Office](../vsto/securing-office-solutions.md).  
...
|Temat|Opis|  
|-----------|-----------------|  
|[Office Development — przykłady](../vsto/office-development-samples.md)|Zawiera łącza do przykładowych aplikacji, które ilustrują korzystanie z pakietu Office i programu SharePoint Programowanie w Visual Studio.|  
|[Przewodniki dotyczące korzystania z programu Word](../vsto/walkthroughs-using-word.md)|Wyświetla listę przewodniki krok po kroku, które stanowią wprowadzenie do narzędzi programowania pakietu Office w Visual Studio i pomoc, aby zilustrować, jak można zintegrować Word aplikacje biznesowe pakietu Office.|  
|[Przewodniki dotyczące korzystania z programu Excel](../vsto/walkthroughs-using-excel.md)|Wyświetla listę przewodniki krok po kroku, które stanowią wprowadzenie do narzędzi programowania pakietu Office w Visual Studio i pomoc, aby zilustrować, jak można zintegrować Excel aplikacje biznesowe pakietu Office.|  
|[Dane w rozwiązaniach pakietu Office — przewodniki](../vsto/data-in-office-solutions-walkthroughs.md)|Wyświetla listę przewodniki krok po kroku, które przedstawiają sposób pracy z danymi w ramach rozwiązań.|  
|[Dostosowywanie interfejsu użytkownika pakietu Office — przewodniki](../vsto/office-ui-customization-walkthroughs.md)|Wyświetla listę przewodniki krok po kroku, które przedstawiają, jak można dostosować interfejs użytkownika (UI) w aplikacji pakietu Microsoft Office.|  
|[Przewodniki dotyczące zabezpieczeń i wdrażania](../vsto/security-and-deployment-walkthroughs.md)|Wyświetla listę przewodniki krok po kroku, ilustrujące konfiguracji zasad zabezpieczeń, aby umożliwić rozwiązanie, aby uruchomić i wdrażania rozwiązania.|  
...
|[Okienko akcji — omówienie](../vsto/actions-pane-overview.md)|Zawiera omówienie okienka zadań na poziomie dokumentu o nazwie w okienku Akcje.|  
