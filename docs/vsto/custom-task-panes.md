...
### <a name="instantiate-the-custom-task-pane"></a>Utworzenie wystąpienia niestandardowego okienka zadań  
...
### <a name="control-the-task-pane-in-multiple-windows"></a>Formant w okienku zadań w wielu okien  
...
### <a name="make-the-custom-task-pane-visible"></a>Udostępnienie niestandardowego okienka zadań  
...
-   [Word, InfoPath i PowerPoint](#WordAndInfoPath)  
 ...
 ![łącze do wideo](../vsto/media/playvideo.gif "łącze do wideo") dla powiązanych pokaz wideo, zobacz [jak zarządzać I: okienka zadań w dodatkach VSTO programu Word?](http://go.microsoft.com/fwlink/?LinkId=136781).  
...
### <a name="prevent-multiple-instances-of-a-custom-task-pane-in-outlook"></a>Zapobiegaj wielu wystąpień niestandardowego okienka zadań w programie Outlook  
