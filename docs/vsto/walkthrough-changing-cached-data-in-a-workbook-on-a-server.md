---
title: 'Wskazówki: Zmiana dane z pamięci podręcznej ze skoroszytu na serwerze | Dokumentacja firmy Microsoft'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
---
# <a name="walkthrough-changing-cached-data-in-a-workbook-on-a-server"></a>Wskazówki: zmiana danych z pamięci podręcznej ze skoroszytu na serwerze
...
## <a name="changing-data-in-the-cached-dataset-by-using-the-console-application"></a>Zmiana danych w pamięci podręcznej zestawu danych za pomocą aplikacji konsoli  
...
2.  Na **.NET** , a następnie wybierz Microsoft.VisualStudio.Tools.Applications.  
