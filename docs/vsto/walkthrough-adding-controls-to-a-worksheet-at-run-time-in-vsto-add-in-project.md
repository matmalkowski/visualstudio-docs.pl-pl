...
## <a name="create-a-new-excel-vsto-add-in-project"></a>Utwórz nowy projekt dodatku VSTO programu Excel  
...
3.  W **Eksploratora rozwiązań**, wybierz pozycję *Ribbon1.cs* lub *Ribbon1.vb*.  
