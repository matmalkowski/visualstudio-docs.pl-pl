...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Zawiera opis strony właściwości, która jest używana do konfigurowania właściwości wdrażania rozwiązania do pakietu Office.  
  
 [Publikowanie kreatora &#40; programowanie Office w Visual Studio &#41;](../vsto/publish-wizard-office-development-in-visual-studio.md)  
...
## <a name="related-sections"></a>Sekcje pokrewne  
 ...
 Zawiera linki do szczegółowych informacji o rozwiązaniu interfejsu użytkownika pakietu Office, manifesty i innych obiektów.  
  
 [Projekty pakietu Office w środowisku Visual Studio](../vsto/office-projects-in-the-visual-studio-environment.md)  
 Opisuje wygląd projektów pakietu Office w Visual Studio zintegrowane środowisko programistyczne.  
