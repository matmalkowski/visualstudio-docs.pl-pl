...
-   Manifest rozmieszczenia, który ma rozszerzenie nazwy pliku *.vsto*. Aby uzyskać więcej informacji, zobacz [manifesty wdrożenia dla rozwiązań pakietu Office](../vsto/deployment-manifests-for-office-solutions.md).  
...
### <a name="network-projects"></a>Projekty sieci  
 W przypadku zestawu lub dokument w lokalizacji w udziale sieciowym, aktualizacji zasady zabezpieczeń lokalnych (na poziomie użytkownika) nie jest wystarczająco, aby umożliwić uruchomienie rozwiązania. Administrator musi przyznać pełne zaufanie na poziomie komputera do zestawów i dokumentów, które są w udziale sieciowym, zanim rozwiązanie będzie uruchamiany. Aby uzyskać więcej informacji na temat sposobu ustawiania zasad zabezpieczeń, zobacz [rozwiązań Secure Office](../vsto/securing-office-solutions.md).  
  
 Dla projektów na poziomie dokumentu należy dodać pełną lokalizację dokumentu do listy zaufanych folderów pakietu Office. Aby uzyskać więcej informacji, zobacz [przyznać zaufania do dokumentów](../vsto/granting-trust-to-documents.md).  
...
## <a name="use-the-clean-command"></a>Użyj polecenia czyste  
...
|[Porady: ponowne włączanie dodatku VSTO, która została wyłączona](../vsto/how-to-re-enable-a-vsto-add-in-that-has-been-disabled.md)|Opisuje sposób ponownie włączyć dodatku VSTO twarde lub soft wyłączono.|  
