...
## <a name="controls-on-word-documents"></a>Formanty w dokumentach programu Word  
 [Przewodnik: Dodawanie kontrolek do dokumentów w czasie wykonywania w dodatku narzędzi VSTO](../vsto/walkthrough-adding-controls-to-a-document-at-run-time-in-a-vsto-add-in.md)  
 Pokazuje, jak dodać kontrolki do dokumentu za pomocą dodatku VSTO.  
  
 [Przewodnik: Zmiana formatowania dokumentu za pomocą kontrolek CheckBox](../vsto/walkthrough-changing-document-formatting-using-checkbox-controls.md)  
