...
# <a name="windows-forms-controls-on-office-documents-overview"></a>Formanty formularzy Windows w dokumentach pakietu Office ― Omówienie
 ...
 Aby uzyskać więcej informacji, zobacz [porady: dodawanie formantów formularzy systemu Windows do dokumentów pakietu Office](../vsto/how-to-add-windows-forms-controls-to-office-documents.md).  
  
 [!INCLUDE[appliesto_controls](../vsto/includes/appliesto-controls-md.md)]  
  
## <a name="using-windows-forms-controls"></a>Formanty formularzy przy użyciu systemu Windows  
 Formanty formularzy systemu Windows można dodać do dokumentów oraz do elementów interfejsu użytkownika można dostosowywać, łącznie z okienka akcji niestandardowych okienek zadań i formularzy systemu Windows. Formanty formularzy systemu Windows mają zwykle takie samo zachowanie w dokumentach jako na inne elementy interfejsu użytkownika, ale istnieją pewne różnice. Aby uzyskać informacje, zobacz [ograniczenia z formantów formularzy systemu Windows w dokumentach pakietu Office](../vsto/limitations-of-windows-forms-controls-on-office-documents.md).  
...
## <a name="adding-windows-forms-controls-programmatically"></a>Programowe dodawanie formantów formularzy systemu Windows  
...
## <a name="using-windows-forms-controls-in-document-level-projects"></a>Przy użyciu systemu Windows formantów formularzy w projektach na poziomie dokumentu  
...
### <a name="creating-custom-user-controls"></a>Tworzenie kontrolki użytkownika niestandardowego  
...
### <a name="arranging-controls-at-design-time"></a>Rozmieszczanie formantów w czasie projektowania  
...
### <a name="preventing-old-data-from-appearing-in-excel-workbooks-during-loading"></a>Uniemożliwia starych danych znajdujących się w skoroszytach programu Excel w czasie ładowania  
...
### <a name="matching-control-size-to-cell-size-on-an-excel-worksheet"></a>Dopasowywanie rozmiaru formantu do komórki rozmiar w arkuszu programu Excel  
...
### <a name="layout-style-of-controls-on-a-word-document"></a>Styl układu kontrolek w dokumencie programu Word  
 ...
 Po dodaniu formantu do dokumentu programu Word w czasie wykonywania, można określić styl układu nowego formantu przy użyciu różnych `Add` \< *kontrolować klasy*> Metoda przeciąża z <xref:Microsoft.Office.Tools.Word.ControlCollection> klasy:  
...
### <a name="adding-components-at-design-time"></a>Dodawanie składników w czasie projektowania  
