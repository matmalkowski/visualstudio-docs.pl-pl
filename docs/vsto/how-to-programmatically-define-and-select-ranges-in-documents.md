...
## <a name="select-a-range-in-a-document-level-customization"></a>Wybierz zakres w dostosowaniu poziomie dokumentu  
...
## <a name="select-a-range-by-using-a-vsto-add-in"></a>Wybierz zakres za pomocą dodatków narzędzi VSTO  
