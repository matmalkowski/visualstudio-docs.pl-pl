...
|[Wizualizatora współbieżności SDK](../profiling/concurrency-visualizer-sdk.md)|Opisuje sposób Instrumentacja kodu źródłowego, aby wyświetlić dodatkowe informacje w wizualizatora współbieżności.|  
