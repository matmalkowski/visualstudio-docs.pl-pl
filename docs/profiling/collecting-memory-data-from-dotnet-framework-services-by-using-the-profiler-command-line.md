...
|**Instrumentacja usługi .NET i zbieranie danych pamięci .NET**|-   [Porady: Instrumentacja usługi .NET Framework i zbieranie danych pamięci](../profiling/how-to-instrument-a-dotnet-framework-service-and-collect-memory-data-by-using-the-profiler-command-line.md)|  
