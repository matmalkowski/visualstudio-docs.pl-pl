---
title: Omówienia (narzędzia wydajności) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-debug
...
ms.workload:
- multiple
ms.openlocfilehash: a71ca4dbffbba1599ebc0423142cdac1ae268b2a
...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 Poznaj podstawy profilowania wydajności z [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędziach profilowania.  
