...
### <a name="to-filter-a-profiling-report-from-the-summary-timeline-graph"></a>Do filtrowania raportu profilowania z podsumowania osi czasu wykresu  
  
1.  Na wykresie widok podsumowania osi czasu kliknij punktu na osi czasu, a następnie przeciągnij na osi czasu myszą do innego punktu.  
  
     Obszar określony jest przyciemnione.  
  
2.  Kliknij przycisk **Filtruj według wyboru**.