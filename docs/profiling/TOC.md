...
##### [Zbieranie statystyk aplikacji dla aplikacji autonomicznych przy użyciu wiersza polecenia profilera](collecting-application-statistics-for-stand-alone-applications.md)
...
###### [Instrukcje: dołączanie profilera do aplikacji autonomicznej .NET Framework i zbieranie statystyk aplikacji przy użyciu wiersza polecenia](how-to-attach-the-profiler-to-a-dotnet-app-and-collect-application-statistics.md)
...
##### [Zbieranie szczegółowych danych o chronometrażu dla aplikacji autonomicznej przy użyciu wiersza polecenia profilera](collecting-detailed-timing-data-for-a-stand-alone-application.md)
...
##### [Zbieranie danych współbieżności dla aplikacji autonomicznych przy użyciu wiersza polecenia profilera](collecting-concurrency-data-for-stand-alone-applications.md)
###### [Instrukcje: uruchamianie aplikacji autonomicznej .NET Framework z profilera w celu zbierania danych współbieżności przy użyciu wiersza polecenia](how-to-launch-a-stand-alone-dotnet-framework-app-to-collect-concurrency-data.md)
...
###### [Instrukcje: dołączanie profilera do aplikacji autonomicznej .NET Framework w celu zbierania danych współbieżności przy użyciu wiersza polecenia](how-to-attach-the-profiler-to-a-dotnet-app-and-collect-concurrency-data.md)
...
##### [Zbieranie danych pamięci .NET Framework dla aplikacji autonomicznych przy użyciu wiersza polecenia profilera](collecting-dotnet-framework-memory-data-for-stand-alone-applications.md)
...
###### [Instrukcje: instrumentowanie składnika autonomicznego .NET Framework i zbieranie danych pamięci za pomocą wiersza polecenia profilera](how-to-instrument-a-dotnet-framework-component-and-collect-memory-data.md)
...
##### [Zbieranie statystyk aplikacji dla aplikacji internetowych ASP.NET przy użyciu metody próbkowania profilera z wiersza polecenia](collecting-application-statistics-for-aspnet-using-the-profiler-sampling-method.md)
...
##### [Zbieranie szczegółowych danych o chronometrażu dla aplikacji internetowej ASP.NET przy użyciu metody instrumentacji profilera z wiersza polecenia](collecting-detailed-timing-data-aspnet-profiler-instrumentation-method.md)
###### [Instrukcje: instrumentacja statycznie skompilowanej aplikacji internetowej ASP.NET i zbieranie szczegółowych danych o chronometrażu przy użyciu wiersza polecenia profilera](how-to-instrument-statically-compiled-aspnet-and-collect-detailed-timing-data.md)
###### [Instrukcje: instrumentacja dynamicznie skompilowanej aplikacji internetowej ASP.NET i zbieranie szczegółowych danych o chronometrażu przy użyciu wiersza polecenia profilera](how-to-instrument-a-dynamically-compiled-aspnet-app-and-collect-timing-data.md)
##### [Zbieranie danych współbieżności dla aplikacji internetowej ASP.NET przy użyciu wiersza polecenia profilera](collecting-concurrency-data-for-an-aspnet-web-application.md)
...
##### [Zbieranie danych pamięci z aplikacji internetowej ASP.NET przy użyciu wiersza polecenia profilera](collecting-memory-data-from-an-aspnet-web-application.md)
...
##### [Instrukcje: modyfikowanie plików Web.Config w celu instrumentowania i profilowania dynamicznie skompilowanych aplikacji internetowych ASP.NET](how-to-modify-web-config-files-to-instrument-dynamically-compiled-aspnet-apps.md)
...
##### [Zbieranie szczegółowych danych o chronometrażu dla usług przy użyciu metody instrumentacji z poziomu wiersza polecenia profilera](collecting-detailed-timing-data-for-services-by-using-the-instrumentation-method.md)
