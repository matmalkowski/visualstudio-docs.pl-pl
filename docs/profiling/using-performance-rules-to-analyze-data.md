...
> [!NOTE]
>  Ostrzeżenia wydajności programu profilującego wygenerowanych przez dynamicznej analizy wykonywania programu i są niezależne od ostrzeżenia analizy kodu. Kod — analiza można również generować ostrzeżenia wydajności dla zarządzanego kodu na podstawie statycznej analizy kodu źródłowego. Aby uzyskać więcej informacji, zobacz [jakości kodu zarządzanego Analizuj](../code-quality/analyzing-managed-code-quality-by-using-code-analysis.md) i [ostrzeżeń dotyczących wydajności](../code-quality/performance-warnings.md).  
