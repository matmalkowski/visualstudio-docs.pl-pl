...
|**Pokrycia**|Wykonuje Instrumentacji pokrycia. Może służyć tylko z następującymi opcjami: **pełne**, **OutputPath**, **wykluczyć**, i **Logfile**...|  
