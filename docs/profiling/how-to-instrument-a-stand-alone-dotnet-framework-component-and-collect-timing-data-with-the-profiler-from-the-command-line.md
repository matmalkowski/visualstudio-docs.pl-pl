...
W tym temacie opisano sposób użycia [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] narzędzia wiersza polecenia narzędzi profilowania na instrumentowanie składnika .NET Framework, takich jak. *exe* lub. *biblioteki dll* pliku i zbieranie szczegółowych danych o chronometrażu.  
