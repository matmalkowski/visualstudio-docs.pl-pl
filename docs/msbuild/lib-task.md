...
|**MinimumRequiredVersion**|Opcjonalne **ciąg** parametru.<br /><br /> Określa minimalną wymaganą wersję podsystemu. Określ listę rozdzielanych przecinkami liczby dziesiętne w zakresie od 0 do 65 535.|  
