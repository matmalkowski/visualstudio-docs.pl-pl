...
|Element|Opis|  
|-------------|-----------------|  
|[Dane wyjściowe](../msbuild/output-element-msbuild.md)|Magazyny danych wyjściowych z zadania w pliku projektu. Może wynosić zero lub więcej `Output` elementów w zadaniu.|  
