...
|[Tworzenie usługi języka starsza wersja](../extensibility/internals/developing-a-legacy-language-service.md)|Zawiera linki do dokumentów dotyczących funkcji zapewniających możliwości dostosowywania [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Edytor core przez dodanie obsługi usługi języka.|  
