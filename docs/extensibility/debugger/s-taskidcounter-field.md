---
title: s_taskIdCounter pola | Dokumentacja firmy Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="staskidcounter-field"></a>s_taskIdCounter pola
Identyfikator następnego dostępne <xref:System.Threading.Tasks.Task> obiektu.  
