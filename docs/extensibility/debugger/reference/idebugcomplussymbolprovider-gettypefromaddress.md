...
#### <a name="parameters"></a>Parametry  
 ...
 `ppField`  
 [out] Zwraca typ tablicy jest reprezentowana przez [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md) interfejsu.  
