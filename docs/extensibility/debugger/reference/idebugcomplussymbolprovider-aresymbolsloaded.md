...
ms.locfileid: "31103581"
---
# <a name="idebugcomplussymbolprovideraresymbolsloaded"></a>IDebugComPlusSymbolProvider::AreSymbolsLoaded
Określa, czy załadowano symbole debugowania dla określony moduł podany identyfikator domeny aplikacji.  
...
## <a name="return-value"></a>Wartość zwracana  
 Jeśli, czy załadowano symbole debugowania, zwraca `S_OK`; w przeciwnym razie zwraca `S_FALSE`.  
