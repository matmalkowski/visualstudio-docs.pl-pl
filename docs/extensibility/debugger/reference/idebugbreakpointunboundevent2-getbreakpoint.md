...
ms.locfileid: "31106922"
---
# <a name="idebugbreakpointunboundevent2getbreakpoint"></a>IDebugBreakpointUnboundEvent2::GetBreakpoint
Pobiera punkt przerwania, która została niepowiązanych.  
...
#### <a name="parameters"></a>Parametry  
 `ppBP`  
 [out] Zwraca [IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md) obiekt, który reprezentuje punkt przerwania, która została niepowiązanych.  
