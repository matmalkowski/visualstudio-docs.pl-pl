...
```  
 ...
 Aby uzyskać bardziej szczegółowe przykład te modyfikacje, zobacz [wskazówki: Tworzenie podstawowych izolowanych aplikacji powłoki](../extensibility/walkthrough-creating-a-basic-isolated-shell-application.md).  
...
|VsDbgCmdUsed.vsct|Polecenie tabeli dla debugera.|  
 ...
 Aby uzyskać więcej informacji, zobacz [projektowania tabeli polecenia XML (. Pliki Vsct)](../extensibility/internals/designing-xml-command-table-dot-vsct-files.md) i [odwołanie do schematu VSCT XML](../extensibility/vsct-xml-schema-reference.md).  
