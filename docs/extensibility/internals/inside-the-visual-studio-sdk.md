...
## <a name="extensibility-architecture"></a>Rozszerzalność architektury
 ...
 ![Ilustracja architektury środowiska](../../extensibility/internals/media/environment.gif "środowiska") uogólniony widok architektury programu Visual Studio
...
> [!NOTE]
> Taka architektura szablonu nie jest obsługiwana dla [!INCLUDE[vcprvc](../../code-quality/includes/vcprvc_md.md)] projektów.
