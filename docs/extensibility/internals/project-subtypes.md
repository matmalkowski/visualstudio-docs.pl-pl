...
## <a name="in-this-section"></a>W tej sekcji  
 ...
 [Sekwencja inicjowania podtypów projektu](../../extensibility/internals/initialization-sequence-of-project-subtypes.md)  
 ...
 [Rozszerzanie modelu obiektu podstawowego projektu](../../extensibility/internals/extending-the-object-model-of-the-base-project.md)  
 ...
 [Współtworzenie Dodaj nowy element — okno dialogowe](../../extensibility/internals/contributing-to-the-add-new-item-dialog-box.md)  
 ...
 [Obsługa specjalizowany wdrożenia](../../extensibility/internals/handling-specialized-deployment.md)  
