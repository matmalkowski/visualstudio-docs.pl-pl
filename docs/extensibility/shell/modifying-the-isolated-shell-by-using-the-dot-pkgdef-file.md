...
```  
 ...
 Aby uzyskać listę ciągów podstawienia, zobacz [podstawienia ciągi używane w. Pkgdef i. Pliki Pkgundef](substitution-strings-used-in-dot-pkgdef-and-dot-pkgundef-files.md).  
...
|Nazwa aplikacji|string|Nazwa aplikacji. Nazwa jest wyświetlana na pasku tytułu okna aplikacji.<br /><br /> Wartość domyślna to nazwa pliku rozwiązania aplikacji.|  
...
|DefaultProjectsLocation|string|Pełna ścieżka domyślny folder projektów. Na przykład<br /><br /> `"DefaultProjectsLocation"="$MyDocuments$\MyVSShellStub\Projects"`<br /><br /> Jeśli **lokalizacji projektów programu Visual Studio** opcja jest dostępna w aplikacji, a następnie to ustawienie dotyczy również domyślnego stanu opcji. Aby uzyskać więcej informacji, zobacz [NIB: Ogólne, projekty i rozwiązania, opcje — Okno dialogowe](http://msdn.microsoft.com/en-us/8f8e37e8-b28d-4b13-bfeb-ea4d3312aeca).<br /><br /> Wartością domyślną jest "$MyDocuments$\\*Nazwa rozwiązania*", gdzie *Nazwa rozwiązania* to nazwa pliku rozwiązania aplikacji.|  
...
|HideSolutionConcept|DWORD|Wartość true, aby tworzyć projekty wszystkie projekty jako autonomiczny i Ukryj rozwiązanie i rozwiązania dotyczące poleceń dla autonomicznych projektów domyślnie; w przeciwnym razie wartość false.<br /><br /> Jeśli **zawsze pokazuj rozwiązania** opcja jest dostępna w aplikacji, a następnie to ustawienie dotyczy również domyślnego stanu opcji. Aby uzyskać więcej informacji, zobacz [NIB: Ogólne, projekty i rozwiązania, opcje — Okno dialogowe](http://msdn.microsoft.com/en-us/8f8e37e8-b28d-4b13-bfeb-ea4d3312aeca).<br /><br /> Wartość domyślna to false.|  
