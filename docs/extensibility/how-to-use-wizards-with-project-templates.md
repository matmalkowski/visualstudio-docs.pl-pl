...
2.  Dodaj nowy projekt VSIX (**pliku** > **New** > ** Projekt > **Visual C#** > ** rozszerzalności > **projekt VSIX**) w tym samym rozwiązaniu co projekt szablonu projektu (w **Eksploratora rozwiązań**, wybierz węzeł rozwiązania, kliknij prawym przyciskiem myszy i wybierz **Dodaj** > **nowy projekt** ). Nadaj mu nazwę **MyProjectWizard.**  
