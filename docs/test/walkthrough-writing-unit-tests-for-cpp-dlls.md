...
2.  W nowym projekcie sprawdzić **unittest1.cpp**  
     ...
     ![Testowanie projektu z testu &#95; KLASY i TEST &#95; Metoda](../test/media/utecpp2.png "UteCpp2")  
...
4.  Skompiluj rozwiązanie, a następnie w Eksploratorze testów, wybierz pozycję **Uruchom wszystkie**.  
     ...
     ![Eksplorator testów jednostkowych &#45; Zakres pomyślny](../test/media/utecpp12.png "UteCpp12")  
