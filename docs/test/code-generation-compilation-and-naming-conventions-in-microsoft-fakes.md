...
-   [Konfigurowanie kodu Generowanie klas zastępczych](#BKMK_Configuring_code_generation_of_stubs)
  
-   [Typ filtrowania](#BKMK_Type_filtering)
  
-   [Stubbing konkretnych klas i metod wirtualnych](#BKMK_Stubbing_concrete_classes_and_virtual_methods)
  
-   [Wewnętrzne typy](#BKMK_Internal_types)
  
-   [Optymalizacja czasu kompilacji](#BKMK_Optimizing_build_times)
  
-   [Unikanie konfliktowe nazwy zestawu](#BKMK_Avoiding_assembly_name_clashing)  
  
-   [Konwencje nazewnictwa elementów sztucznych](#BKMK_Fakes_naming_conventions)  
  
-   [Typ podkładki i stub typ konwencje nazewnictwa](#BKMK_Shim_type_and_stub_type_naming_conventions)
  
-   [Podkładki delegata właściwość skrótowa delegata pola lub konwencje nazewnictwa](#BKMK_Shim_delegate_property_or_stub_delegate_field_naming_conventions)
  
-   [Konwencje nazewnictwa typu parametru](#BKMK_Parameter_type_naming_conventions)
  
-   [Reguły cykliczne](#BKMK_Recursive_rules)  
...
-   Dodawanie `!` na końcu filtr, spowoduje to dokładne dopasowanie uwzględniające:  
  
     `el!`"tekst hello" jest niezgodna  
  
     `hello!`Dopasowuje "tekst hello"  
  
-   Dodawanie `*` na końcu filtr, spowoduje to zgodny prefiks ciągu:  
 ...
 **Wewnętrzny typów w zestawach o silnej nazwie**  
 ...
 Jeśli zastąpionym podkładką zestawu ma silnej nazwy i mają dostęp wewnętrzne typy zestawu:  
  
-   Zarówno z zestawu testowego i zestawu elementów sztucznych musi być silna.  
  
-   Należy dodać klucze publiczne i zestawu elementów sztucznych do badania **InternalsVisibleToAttribute** atrybutów w zestawach zastąpionym podkładką. Poniżej przedstawiono wygląd naszego atrybuty przykład w kodzie zestawu zastąpionym podkładką podczas silna zastąpionym podkładką zestawu:  
...
###  <a name="BKMK_Optimizing_build_times"></a>Optymalizacja czasu kompilacji  
 ...
 Z projektów testów jednostkowych można wykonywać tylko odwołanie do skompilowane zestawy elementów sztucznych, które są objęte FakesAssemblies w folderze projektu.  
...
4.  Z projektu testowego  
    ...
    -   Upewnij się, że odwołanie do środowiska wykonawczego elementów sztucznych biblioteki DLL:  
         ...
         C:\Program Files\Microsoft 12.0\Common7\IDE\PublicAssemblies\Microsoft.QualityTools.Testing.Fakes.dll programu Visual Studio  
...
###  <a name="BKMK_Avoiding_assembly_name_clashing"></a>Unikanie konfliktowe nazwy zestawu  
 W środowisku Team Build wszystkie dane wyjściowe kompilacji są scalane w jeden katalog. W przypadku wielu projektów za pomocą elementów sztucznych może się zdarzyć, zestawy elementów sztucznych z różnych wersji zastąpienie siebie nawzajem. Na przykład TestProject1 substytutów mscorlib.dll z programu .NET Framework 2.0 i TestProject2 substytutów mscorlib.dll dla programu .NET Framework 4 yield czy do biblioteki mscorlib. Zestaw Substytuowany Fakes.dll.  
