...
|Klient Dynamics (Ax) 2012|Akcje odtwarzania i nagrywania są obsługiwane częściowo. Zobacz [10 kodowanego interfejsie użytkownika Visual Studio / nagrań akcji pomocy technicznej dla oprogramowania Microsoft Dynamics](https://blogs.msdn.microsoft.com/dave_froslie/2011/09/01/visual-studio-10-coded-ui-action-recordings-support-for-microsoft-dynamics-ax-2012/) Aby uzyskać szczegółowe informacje.|
|SAP|Nieobsługiwane.|
