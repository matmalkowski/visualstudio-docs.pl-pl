---
title: "Wskazówki: Tworzenie i Uruchamianie testów jednostek dla kodu zarządzanego | Dokumentacja firmy Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
 ...
 **Analizuj wyniki testów**  
 ...
 Wynik testu zawiera komunikat zawierający opis błędu. Dla `AreEquals` metody komunikat wyświetlany przez możesz oczekiwanym ((**Oczekiwano\<*XXX*>**parametru) i co faktycznie otrzymano (  **Rzeczywista\<*YYY* >**  parametru). Oczekiwaną saldo zrezygnować z saldo początkowe, ale zamiast tego wzrosła o ilość wycofanie.  
