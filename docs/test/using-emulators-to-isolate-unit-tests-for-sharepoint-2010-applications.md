...
-   [Dodawanie pakietu emulatory do projektu testowego](#BKMK_Adding_the_Emulators_package_to_a_test_project)  
  
-   [Uruchomione z emulacji metody testowej](#BKMK__Running_a_test_method_in_the_emulation_context)  
  
 [Tworzenie podwójnego zastosowania klasy i metody](#BKMK_Creating_dual_use_classes_and_methods)  
  
 [Przy użyciu TestInitialize i TestCleanup atrybutów, aby utworzyć podwójnego zastosowania testu — klasa](#BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class)  
  
 [Obsługa nie jest emulowana metod programu SharePoint](#BKMK_Handling_non_emulated_SharePoint_methods)  
  
 [Emulacja pisania testów od początku i podsumowanie](#BKMK_Writing_emulation_tests_from_scratch__and_a_summary)  
  
 [Przykład](#BKMK_Example)  
  
 [Emulowane typów programu SharePoint](#BKMK_Emulated_SharePoint_types)  
...
##  <a name="BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class"></a>Przy użyciu TestInitialize i TestCleanup atrybutów, aby utworzyć podwójnego zastosowania testu — klasa  
...
## <a name="see-also"></a>Zobacz też  
 ...
 [Wydajności sieci Web i obciążenia testowanie aplikacji SharePoint 2010 i 2013](/devops-test-docs/test/web-performance-and-load-testing-sharepoint-2010-and-2013-applications)   
