---
title: Jak używać Google testu dla języka C++ w programie Visual Studio
ms.date: 11/04/2017
...
![Zainstaluj usługi Google testu](media/cpp-google-component.png)
