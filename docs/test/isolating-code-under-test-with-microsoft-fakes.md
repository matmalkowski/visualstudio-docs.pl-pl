...
## <a name="in-this-section"></a>W tej sekcji  
 [Stosowanie wycinków kodu do izolowania części aplikacji ze sobą w celu przeprowadzania testów jednostkowych](../test/using-stubs-to-isolate-parts-of-your-application-from-each-other-for-unit-testing.md)  
 ...
 [Generowanie kodu, kompilowania i nazywania w Microsoft Fakes](../test/code-generation-compilation-and-naming-conventions-in-microsoft-fakes.md)
