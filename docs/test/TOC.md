...
### [Szybki start](getting-started-with-unit-testing.md)
...
### [Podręcznik dotyczący funkcji IntelliTest](intellitest-manual/introduction.md)
...
## [Testowanie aplikacji platformy UWP za pomocą programu Visual Studio](testing-store-apps-with-visual-studio.md)
### [Tworzenie i uruchamianie testów jednostkowych dla aplikacji platformy UWP w programie Visual Studio](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
...
#### [Testowanie jednostek kodu języka Visual C# w aplikacji platformy UWP](unit-testing-visual-csharp-code-in-a-store-app.md)
#### [Uruchamianie testów jednostkowych aplikacji platformy UWP w programie Visual Studio](run-unit-tests-for-store-apps-in-visual-studio.md)
### [Analizowanie jakości kodu w aplikacjach platformy UWP przy użyciu statycznej analizy kodu w programie Visual Studio](analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analizowanie jakości kodu języków Visual Basic i C# w aplikacjach platformy UWP przy użyciu statycznej analizy kodu w programie Visual Studio](analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analizowanie jakości kodu języka C++ w aplikacjach platformy UWP przy użyciu statycznej analizy kodu w programie Visual Studio](analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
