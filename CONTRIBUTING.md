...
In this topic, you'll see the basic process for adding or updating content in the [Visual Studio documentation site](https://docs.microsoft.com/pl-pl/).
...
**Step 2:** Fork the `MicrosoftDocs/visualstudio-docs.pl-pl` repo.
...
**Step 5:** Submit a Pull Request (PR) from your branch to `MicrosoftDocs/visualstudio-docs.pl-pl/master`.
