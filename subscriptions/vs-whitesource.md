---
title: Korzyści WhiteSource Bolt | Dokumentacja firmy Microsoft
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 01/11/2017
...
5.  Otwórz pulpit nawigacyjny projektu programu Visual Studio Team Services (VSTS), kliknij na **kompilacji i wydania** menu i wybierz polecenie **WhiteSource Bolt**.
...
| Program Visual Studio Professional (standardowy, roczne w chmurze) | VL, Azure, Retail                                       | Nie jest dostępna                                                           |NA         |
