...
3.  Aby użyć korzyści Opsgility, kliknij na **Pobierz** łącze w dolnej części fragmentu korzyści.   Otrzymasz powiadomienie, że kod kuponu zostały pomyślnie pobrane.  Kliknij przycisk **Aktywuj** aby kontynuować.

    ![Korzyści Opsgility kafelka](_img\vs-opsgility\vs-opsgility-tile.png)


4.  Użytkownik zostanie przekierowany do [Opsgility szkolenie Online dla programu Visual Studio Enterprise](https://www.opsgility.com/vse) strony docelowej.  (Może być oferowana możliwość rozpoczęcia sesji rozmów z specjalisty pomocy technicznej.  Jeśli nie chcesz, aby rozpocząć czat, można zminimalizować tego okna.)  Wypełnij wymagane informacje kontaktowe i kliknij przycisk **zarejestrować**.  

    ![Strona docelowa Opsgility korzyści](_img\vs-opsgility\vs-opsgility-registration.png)

5.  To wszystko jest do niego!  Możesz rozpocząć naukę.  Aby pomóc Ci rozpocząć, Brak listy ścieżek sugerowane learning podanego w lewej części strony.  Owocnej pracy.
