...
Jeśli nie masz pewności, kto jest kontakt podstawowy/powiadomienia mają zostać dodane do nowego programu Visual Studio subskrypcje portalu administracyjnego, te informacje po zalogowaniu się można znaleźć [VLSC](https://www.microsoft.com/Licensing/servicecenter/default.aspx). Spójrz na [w tym artykule](https://www.visualstudio.com/subscriptions/support/locate-primary-contact/ "jak Znajdź mój głównej osoby kontaktowej?") czynności na lokalizowanie kontakt podstawowy/powiadomienia w w centrum VLSC.
