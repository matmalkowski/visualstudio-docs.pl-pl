...
Jako aktywny subskrybent Visual Studio można użyć różnych funkcji w VSTS dostępnych w ramach subskrypcji jako korzyści. Dzięki temu można używać tych samych funkcji każdego konta usługi VSTS, w którym użytkownik jest członkiem — utworzone konto lub zostały dodane przez kogoś innego.
...
[Załóż bezpłatne konto programu VSTS](https://www.visualstudio.com/team-services/)
